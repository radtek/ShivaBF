...
namespace SHF.DataAccess
{
    public class SHFDBContext : DbContext
    {
        ...
        public DbSet<SHF.EntityModel.Services4Section345MasterButtonsChild> Services4Section345MasterButtonsChild { get; set; }
        public DbSet<SHF.EntityModel.Services4Section345MasterFeaturesDetails> Services4Section345MasterFeatures { get; set; }
        
        public DbSet<SHF.EntityModel.Services4Section678FieldMaster> Services4Section678FieldMaster { get; set; }
        public DbSet<SHF.EntityModel.Services4Section678FieldValues> Services4Section678FieldValues { get; set; }
        /*service 5*/
        ...
        public DbSet<SHF.EntityModel.PageViewsReport> PageViewsReport { get; set; }
