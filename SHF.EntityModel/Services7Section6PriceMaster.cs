...
{
    [Table("Tbl_Services7Section6PriceMaster", Schema = "dbo")]
    public class Services7Section6PriceMaster : BaseEntity
    {
        [Key]
        ...
        public virtual Services7Master Services7Master { get; set; }
