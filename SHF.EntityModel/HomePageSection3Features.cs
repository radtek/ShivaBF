...
{
    [Table("Tbl_HomePageSection3Features", Schema = "dbo")]
    public class HomePageSection3Features : BaseEntity
    {
        [Key]
        [DatabaseGeneratedAttribute(DatabaseGeneratedOption.Identity)]
        [Column(Order = 1)]
        public virtual long ID { get; set; }
        [ForeignKey("HomePageSection3_Id")]
        public virtual HomePageSection3 HomePageSection3 { get; set; }
