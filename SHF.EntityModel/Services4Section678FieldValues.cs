...
{
    [Table("Tbl_Services4Section678FieldValues", Schema = "dbo")]
    public class Services4Section678FieldValues : BaseEntity
    {
        [Key]
        ...
        [ForeignKey("S4S678FM_Id")]
        public virtual Services4Section678FieldMaster Services4Section678FieldMaster { get; set; }
