...
{
   public class ServiceType5ViewModel : BaseViewModel
    {
    ...
    public class ServiceType5Section2MasterViewModel : BaseViewModel
    {
        ...
        public List<ServiceType5Section2MasterFeaturesDetailsViewModel> ServiceType5Section2MasterFeaturesDetailsViewModel { get; set; }
    }

    public class ServiceType5Section2MasterFeaturesDetailsViewModel : BaseViewModel
    {
