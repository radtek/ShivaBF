...
namespace SHF.ViewModel.FrontEnd
{
   public class ServiceType1ViewModel : BaseViewModel
    ...
    public class Services1Section6PriceMasterViewModel : BaseViewModel
    {
        ...
        public System.String TenantName { get; set; }
        public System.Int64 Tenant_ID { get; set; }
        public List<ViewModel.FrontEnd.PriceFeaturesMappingViewModel> PriceFeaturesMappingViewModel { get; set; }
