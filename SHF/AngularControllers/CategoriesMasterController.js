 ...
 $scope.upload = function (file) {
        ...
        $scope.createOreditAsyncForm = function () {
            ...
            if ($scope.myForm.$valid) {
                $scope.path = ($scope.CategoriesMasterCreateOrEditViewModel.ID == undefined || $scope.CategoriesMasterCreateOrEditViewModel.ID == null || $scope.CategoriesMasterCreateOrEditViewModel.ID == 0) ? "/Post/Bank/CreateAsync" : "/Post/Bank/EditAsync";
