angular.module(config.app).controller('Services8MasterCtrl', ['$scope', '$http', '$window','SubSubCategoriesMasterCRUD', 'Services8MasterCRUD', 'TenantCRUD','CustomService','CodeValueCRUD',
    function ($scope, $http, $window,SubSubCategoriesMasterCRUD, Services8MasterCRUD, TenantCRUD,CustomService,CodeValueCRUD) {      
        $scope.path = "";
        $scope.errors = {};
