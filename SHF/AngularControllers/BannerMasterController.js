angular.module(config.app).controller('BannerMasterCtrl', ['$scope', '$http', '$window', 'BannerMasterCRUD', 'TenantCRUD','CustomService',
    function ($scope, $http, $window, BannerMasterCRUD, TenantCRUD,CustomService) {      
        $scope.path = "";
        $scope.errors = {};
        ...
        $scope.BannerMasterCreateOrEditViewModel.Tenant_ID = $scope.Cookie_Tenant_ID;
        ...
        $scope.CreateAsync = function () {
            ...
            if ($scope.Cookie_Tenant_ID <= 0) {
                ...
                $scope.BannerMasterCreateOrEditViewModel.Tenant_ID = $scope.Cookie_Tenant_ID;
                $scope.BindUnitOfMeasurementDropDownList($scope.BannerMasterCreateOrEditViewModel.Tenant_ID);
            }
        ...
        $scope.createOreditAsyncForm = function () {
            ...
            if ($scope.myForm.$valid) {
                $scope.path = ($scope.BannerMasterCreateOrEditViewModel.ID == undefined || $scope.BannerMasterCreateOrEditViewModel.ID == null || $scope.BannerMasterCreateOrEditViewModel.ID == 0) ? "/Post/Banner/CreateAsync" : "/Post/Banner/EditAsync";
                $http.post($scope.path, $scope.BannerMasterCreateOrEditViewModel,
                    {
        ...
        $scope.UploadFileIndividual = function (fileToUpload, name, type, size, index) {
            var tenantId = $scope.BannerMasterCreateOrEditViewModel.Tenant_ID;
