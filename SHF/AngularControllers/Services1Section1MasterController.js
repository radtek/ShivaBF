angular.module(config.app).controller('Services1Section1MasterCtrl', ['$scope', '$http', '$window','CategoriesMasterCRUD','SubCategoriesMasterCRUD', 'Services1Section1MasterCRUD', 'TenantCRUD','CustomService','CodeValueCRUD',
    function ($scope, $http, $window,CategoriesMasterCRUD,SubCategoriesMasterCRUD, Services1Section1MasterCRUD, TenantCRUD,CustomService,CodeValueCRUD) {      
        $scope.path = "";
        $scope.errors = {};
        ...
        $scope.Services1Section1MasterCreateOrEditViewModel.SelectedSubSubCategory_ID = -1;
...
$scope.LoadAllSubSubCategory = function () {
            let catId = $scope.Services1Section1MasterCreateOrEditViewModel.SubSubCategory_ID;
