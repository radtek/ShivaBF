angular.module(config.app).controller('Services1MasterCtrl', ['$scope', '$http', '$window','CategoriesMasterCRUD','SubCategoriesMasterCRUD', 'Services1MasterCRUD', 'TenantCRUD','CustomService','CodeValueCRUD',
    function ($scope, $http, $window,CategoriesMasterCRUD,SubCategoriesMasterCRUD, Services1MasterCRUD, TenantCRUD,CustomService,CodeValueCRUD) {      
        $scope.path = "";
        $scope.errors = {};
        ...
        $scope.Services1MasterCreateOrEditViewModel.SelectedSubSubCategory_ID = -1;
...
$scope.LoadAllSubSubCategory = function () {
            let catId = $scope.Services1MasterCreateOrEditViewModel.SubSubCategory_ID;
