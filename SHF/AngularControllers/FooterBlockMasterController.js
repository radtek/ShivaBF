    ...
    function ($scope, $http, $window, FooterBlockMasterCRUD, TenantCRUD,CustomService) {      
        ...
        $scope.createOreditAsyncForm = function () {
            ...
            if ($scope.myForm.$valid) {
                $scope.path = ($scope.FooterBlockMasterCreateOrEditViewModel.ID == undefined || $scope.FooterBlockMasterCreateOrEditViewModel.ID == null || $scope.FooterBlockMasterCreateOrEditViewModel.ID == 0) ? "/Post/Bank/CreateAsync" : "/Post/Bank/EditAsync";
