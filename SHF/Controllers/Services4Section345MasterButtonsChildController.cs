...
{
    [AllowAnonymous]
    public class Services4Section345MasterButtonsChildController : BaseController
    {
        ...
        private Business.Interface.IServices4Section345MasterButtonsChild businessServices4Section345MasterButtonsChild;
        private Business.Interface.IServices4Section345Master businessServices4Section345Master;

        public Services4Section345MasterButtonsChildController(Business.Interface.IMessage Imessage, Business.Interface.IServices4Section345MasterButtonsChild IServices4Section345MasterButtonsChild, Business.Interface.IServices4Section345Master IServices4Section345Master)
        {
            this.businessMessage = Imessage;
            this.businessServices4Section345MasterButtonsChild = IServices4Section345MasterButtonsChild;
        ...
        [HttpPost]
        [Route("Post/Services4Section345MasterButtonsChild/IndexAsync")]
        [ValidateAntiForgeryTokens]
        public async Task<ActionResult> IndexAsync()
        {
            BusinessResultViewModel<ViewModel.Services4Section345MasterButtonsChildIndexViewModel> businessResult;
            try
            {
                using (var transaction = new TransactionScope(TransactionScopeOption.Required, new TransactionOptions() { IsolationLevel = IsolationLevel.ReadUncommitted }))
                {
                    try
                    {
                        ...
                        businessResult = this.businessServices4Section345MasterButtonsChild.Index(Request, tenantId);
        ...
        [AuditAttribute]
        [ValidateAntiForgeryTokens]
        [Route("Post/Services4Section345MasterButtonsChild/CreateAsync")]
        public async Task<ActionResult> CreateAsync(ViewModel.Services4Section345MasterButtonsChildCreateOrEditViewModel model)
        {
            try
            {
                ...
                else
                {
                    using (var transaction = new TransactionScope())
                    {
                        try
                        {
                            var productId = businessServices4Section345MasterButtonsChild.FindBy(subCategories => subCategories.Tenant_ID == model.Tenant_ID && subCategories.ID == model.ID).FirstOrDefault();
                            ...
                            else
                            {
                                ...
                                var entity = new EntityModel.Services4Section345MasterButtonsChild();
                                entity.Tenant = null;
                                ...
                                entity.FeatureDescription = model.FeatureDescription;
                                ...
                                this.businessServices4Section345MasterButtonsChild.Create(entity);
                                transaction.Complete();
        ...
        [HttpGet]
        [Route("Get/Services4Section345MasterButtonsChild/EditAsync")]
            ...
            try
            {
                using (var transaction = new TransactionScope(TransactionScopeOption.Required, new TransactionOptions() { IsolationLevel = IsolationLevel.ReadUncommitted }))
                {
                    try
                    {
                        ...
                        {
                            var entity = this.businessServices4Section345MasterButtonsChild.GetById(Id);
                            ...
                            if (entity.IsNotNull())
                            {
                                ...
                                var model = new ViewModel.Services4Section345MasterButtonsChildCreateOrEditViewModel();
                                ...
                                var response = new JsonResponse<Services4Section345MasterButtonsChildCreateOrEditViewModel>()
                                {
                                    Type = busConstant.Messages.Type.RESPONSE,
                                    Entity = model
                                };
        ...
        [AuditAttribute]
        [ValidateAntiForgeryTokens]
        [Route("Post/Services4Section345MasterButtonsChild/EditAsync")]
        public async Task<ActionResult> EditAsync(ViewModel.Services4Section345MasterButtonsChildCreateOrEditViewModel model)
        {
            try
            {
                ...
                else
                {
                    using (var transaction = new TransactionScope())
                    {
                        try
                        {
                            var SubCategoriesData = businessServices4Section345MasterButtonsChild.FindBy(SubCategories => SubCategories.Tenant_ID == model.Tenant_ID && SubCategories.ID == model.ID).FirstOrDefault();
                            ...
                            {
                                var entityServices = this.businessServices4Section345Master.FindBy(Services4Section345Master => Services4Section345Master.SubSubCat_Id == model.SubSubCat_Id).FirstOrDefault();
                                var entity = this.businessServices4Section345MasterButtonsChild.GetById(Convert.ToInt64(model.ID));
                                if (entity.IsNotNull())
                                {
                                    entity.Tenant = null;
                                    entity.Services4Section345Master = null;
                                    ...
                                    entity.MetaDescription = model.MetaDescription;
                                    entity.Tenant_ID = model.Tenant_ID;
                                    this.businessServices4Section345MasterButtonsChild.Update(entity);
        ...
        [AuditAttribute]
        [ValidateAntiForgeryTokens]
        [Route("Post/Services4Section345MasterButtonsChild/Delete")]
            ...
            try
            {
                using (var transaction = new TransactionScope(TransactionScopeOption.Required, new TransactionOptions() { IsolationLevel = IsolationLevel.ReadUncommitted }))
                {
                    try
                    {
                        ...
                        {
                            this.businessServices4Section345MasterButtonsChild.Delete(Convert.ToInt64(Id));
        ...
        [HttpGet]
        [Route("Get/Services4Section345MasterButtonsChild/DropdownListbyTenantAsync")]
        public async Task<ActionResult> GetServices4Section345MasterButtonsChildByTenantIdAsync(long Id)
        {
            try
            {
                using (var transaction = new TransactionScope(TransactionScopeOption.Required, new TransactionOptions() { IsolationLevel = IsolationLevel.ReadUncommitted }))
                {
                    try
                    {
                        ...
                        {
                            var entities = this.businessServices4Section345MasterButtonsChild.FindBy(category => category.ID == Id).Select(x => new ViewModel.SubCategoriesDropdownListViewModel
                            {
                                ID = x.ID,
