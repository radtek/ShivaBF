...
{
    [AllowAnonymous]
    public class Services3HeadingButtonsController : BaseController
    {
        ...
        private Business.Interface.IServices3HeadingButtons businessServices3HeadingButtons;
        private Business.Interface.IServices3Master businessServices3Master;

        public Services3HeadingButtonsController(Business.Interface.IMessage Imessage, Business.Interface.IServices3HeadingButtons IServices3HeadingButtons, Business.Interface.IServices3Master IServices3Master)
        {
            this.businessMessage = Imessage;
            this.businessServices3HeadingButtons = IServices3HeadingButtons;
        ...
        [Route("Configurations/Master/ServiceType3/SectionHeadingButtons")]
        [Route("Settings/Master/ServiceType3/SectionHeadingButtons")]
        ...
        [HttpPost]
        [Route("Post/Services3HeadingButtons/IndexAsync")]
        [ValidateAntiForgeryTokens]
        public async Task<ActionResult> IndexAsync()
        {
            BusinessResultViewModel<ViewModel.Services3HeadingButtonsIndexViewModel> businessResult;
            try
            {
                using (var transaction = new TransactionScope(TransactionScopeOption.Required, new TransactionOptions() { IsolationLevel = IsolationLevel.ReadUncommitted }))
                {
                    try
                    {
                        ...
                        businessResult = this.businessServices3HeadingButtons.Index(Request, tenantId);
        ...
        [AuditAttribute]
        [ValidateAntiForgeryTokens]
        [Route("Post/Services3HeadingButtons/CreateAsync")]
        public async Task<ActionResult> CreateAsync(ViewModel.Services3HeadingButtonsCreateOrEditViewModel model)
        {
            try
            {
                ...
                else
                {
                    using (var transaction = new TransactionScope())
                    {
                        try
                        {
                            var productId = businessServices3HeadingButtons.FindBy(Services2Section3Download => Services2Section3Download.Tenant_ID == model.Tenant_ID && Services2Section3Download.ID == model.ID).FirstOrDefault();
                            ...
                            else
                            {
                                ...
                                var entity = new EntityModel.Services3HeadingButtons();
                                entity.Tenant = null;
                                //entity.Services3HeadingButtonss = null;
                                ...
                                this.businessServices3HeadingButtons.Create(entity);
                                transaction.Complete();
        ...
        [HttpGet]
        [Route("Get/Services3HeadingButtons/EditAsync")]
            ...
            try
            {
                using (var transaction = new TransactionScope(TransactionScopeOption.Required, new TransactionOptions() { IsolationLevel = IsolationLevel.ReadUncommitted }))
                {
                    try
                    {
                        ...
                        {
                            var entity = this.businessServices3HeadingButtons.GetById(Id);
                            ...
                            if (entity.IsNotNull())
                            {
                                ...
                                var model = new ViewModel.Services3HeadingButtonsCreateOrEditViewModel();
                                ...
                                var response = new JsonResponse<Services3HeadingButtonsCreateOrEditViewModel>()
                                {
                                    Type = busConstant.Messages.Type.RESPONSE,
                                    Entity = model
                                };
        ...
        [AuditAttribute]
        [ValidateAntiForgeryTokens]
        [Route("Post/Services3HeadingButtons/EditAsync")]
        public async Task<ActionResult> EditAsync(ViewModel.Services3HeadingButtonsCreateOrEditViewModel model)
        {
            try
            {
                ...
                else
                {
                    using (var transaction = new TransactionScope())
                    {
                        try
                        {
                            var Services2Section3DownloadData = businessServices3HeadingButtons.FindBy(Services2Section3Download => Services2Section3Download.Tenant_ID == model.Tenant_ID && Services2Section3Download.ID == model.ID).FirstOrDefault();
                            ...
                            {
                                var entityServices = this.businessServices3Master.FindBy(Services3Master => Services3Master.SubSubCat_Id == model.SubSubCat_Id).FirstOrDefault();
                                var entity = this.businessServices3HeadingButtons.GetById(Convert.ToInt64(model.ID));
                                if (entity.IsNotNull())
                                {
                                    ...
                                    entity.SubSubCategoriesMaster = null;
                                    entity.Services3Master = null;
                                    this.businessServices3HeadingButtons.Update(entity);
        ...
        [AuditAttribute]
        [ValidateAntiForgeryTokens]
        [Route("Post/Services3HeadingButtons/Delete")]
            ...
            try
            {
                using (var transaction = new TransactionScope(TransactionScopeOption.Required, new TransactionOptions() { IsolationLevel = IsolationLevel.ReadUncommitted }))
                {
                    try
                    {
                        ...
                        {
                            this.businessServices3HeadingButtons.Delete(Convert.ToInt64(Id));
        ...
        [HttpGet]
        [Route("Get/Services3HeadingButtons/DropdownListbyTenantAsync")]
        public async Task<ActionResult> GetServices3HeadingButtonsByTenantIdAsync(long Id)
        {
            try
            {
                using (var transaction = new TransactionScope(TransactionScopeOption.Required, new TransactionOptions() { IsolationLevel = IsolationLevel.ReadUncommitted }))
                {
                    try
                    {
                        ...
                        {
                            var entities = this.businessServices3HeadingButtons.FindBy(product => product.Tenant_ID == Id).Select(x => new ViewModel.Services3HeadingButtonsDropdownListViewModel
                            {
                                ID = x.ID,
                            ...
                            {
                                var response = new JsonResponse<IEnumerable<ViewModel.Services3HeadingButtonsDropdownListViewModel>>()
                                {
                                    Type = busConstant.Messages.Type.RESPONSE,
                                    Entity = entities
                                };
