...
{
    [AllowAnonymous]
    public class Services1Section4MasterController : BaseController
    {
        ...
        private Business.Interface.IServices1Section4Master businessServices1Section4Master;
        private Business.Interface.IServices1Master businessServices1Master;

        public Services1Section4MasterController(Business.Interface.IMessage Imessage, Business.Interface.IServices1Section4Master IServices1Section4Master, Business.Interface.IServices1Master IServices1Master)
        {
            this.businessMessage = Imessage;
            this.businessServices1Section4Master = IServices1Section4Master;
        ...
        [Route("Configurations/Master/ServiceType1/Section4")]
        [Route("Settings/Master/ServiceType1/Section4")]
        ...
        [HttpPost]
        [Route("Post/Services1Section4/IndexAsync")]
        [ValidateAntiForgeryTokens]
        public async Task<ActionResult> IndexAsync()
        {
            BusinessResultViewModel<ViewModel.Services1Section4MasterIndexViewModel> businessResult;
            try
            {
                using (var transaction = new TransactionScope(TransactionScopeOption.Required, new TransactionOptions() { IsolationLevel = IsolationLevel.ReadUncommitted }))
                {
                    try
                    {
                        ...
                        businessResult = this.businessServices1Section4Master.Index(Request, tenantId);
        ...
        [AuditAttribute]
        [ValidateAntiForgeryTokens]
        [Route("Post/Services1Section4Master/CreateAsync")]
        public async Task<ActionResult> CreateAsync(ViewModel.Services1Section4MasterCreateOrEditViewModel model)
        {
            try
            {
                ...
                else
                {
                    using (var transaction = new TransactionScope())
                    {
                        try
                        {
                            var productId = businessServices1Section4Master.FindBy(Services1Section4 => Services1Section4.Tenant_ID == model.Tenant_ID && Services1Section4.ID == model.ID).FirstOrDefault();
                            ...
                            else
                            {
                                ...
                                var entity = new EntityModel.Services1Section4Master();
                                entity.Tenant = null;
                                ...
                                this.businessServices1Section4Master.Create(entity);
                                transaction.Complete();
        ...
        [HttpGet]
        [Route("Get/Services1Section4Master/EditAsync")]
            ...
            try
            {
                using (var transaction = new TransactionScope(TransactionScopeOption.Required, new TransactionOptions() { IsolationLevel = IsolationLevel.ReadUncommitted }))
                {
                    try
                    {
                        ...
                        {
                            var entity = this.businessServices1Section4Master.GetById(Id);
                            ...
                            if (entity.IsNotNull())
                            {
                                ...
                                var model = new ViewModel.Services1Section4MasterCreateOrEditViewModel();
                                ...
                                var response = new JsonResponse<Services1Section4MasterCreateOrEditViewModel>()
                                {
                                    Type = busConstant.Messages.Type.RESPONSE,
                                    Entity = model
                                };
        ...
        [AuditAttribute]
        [ValidateAntiForgeryTokens]
        [Route("Post/Services1Section4Master/EditAsync")]
        public async Task<ActionResult> EditAsync(ViewModel.Services1Section4MasterCreateOrEditViewModel model)
        {
            try
            {
                ...
                else
                {
                    using (var transaction = new TransactionScope())
                    {
                        try
                        {
                            var Services1Section4Data = businessServices1Section4Master.FindBy(Services1Section4 => Services1Section4.Tenant_ID == model.Tenant_ID && Services1Section4.ID == model.ID).FirstOrDefault();
                            ...
                            {
                                var entityServices = this.businessServices1Master.FindBy(services1master => services1master.SubSubCat_Id == model.SubSubCat_Id).FirstOrDefault();
                                var entity = this.businessServices1Section4Master.GetById(Convert.ToInt64(model.ID));
                                if (entity.IsNotNull())
                                {
                                    entity.Tenant = null;
                                    entity.SubSubCategoriesMaster = null;
                                    ...
                                    entity.Tenant_ID = model.Tenant_ID;
                                    //Mapper.Map(model, entity);
                                    this.businessServices1Section4Master.Update(entity);
        ...
        [AuditAttribute]
        [ValidateAntiForgeryTokens]
        [Route("Post/Services1Section4Master/Delete")]
            ...
            try
            {
                using (var transaction = new TransactionScope(TransactionScopeOption.Required, new TransactionOptions() { IsolationLevel = IsolationLevel.ReadUncommitted }))
                {
                    try
                    {
                        ...
                        {
                            this.businessServices1Section4Master.Delete(Convert.ToInt64(Id));
        ...
        [HttpGet]
        [Route("Get/Services1Section4Master/DropdownListbyTenantAsync")]
        public async Task<ActionResult> GetServices1Section4MasterByTenantIdAsync(long Id)
        {
            try
            {
                using (var transaction = new TransactionScope(TransactionScopeOption.Required, new TransactionOptions() { IsolationLevel = IsolationLevel.ReadUncommitted }))
                {
                    try
                    {
                        ...
                        {
                            var entities = this.businessServices1Section4Master.FindBy(product => product.Tenant_ID == Id).Select(x => new ViewModel.Services1Section4MasterDropdownListViewModel
                            {
                                ID = x.ID,
                            ...
                            {
                                var response = new JsonResponse<IEnumerable<ViewModel.Services1Section4MasterDropdownListViewModel>>()
                                {
                                    Type = busConstant.Messages.Type.RESPONSE,
                                    Entity = entities
                                };
