...
namespace SHF.Controllers
{
    ...
    public class Services1Section4MasterController : BaseController
    {
        ...
        [Route("Configurations/Master/Services1Section4/Index")]
        [Route("Settings/Master/Services1Section4/Index")]
            ...
            try
            {
                using (var transaction = new TransactionScope(TransactionScopeOption.Required, new TransactionOptions() { IsolationLevel = IsolationLevel.ReadUncommitted }))
                {
                    try
                    {
                        ...
                        {
                            var entities = this.businessServices1Section4Master.FindBy(product => product.Tenant_ID == Id).Select(x => new ViewModel.Services1Section4DropdownListViewModel
                            {
                                ID = x.ID,
                            ...
                            {
                                var response = new JsonResponse<IEnumerable<ViewModel.Services1Section4DropdownListViewModel>>()
                                {
                                    Type = busConstant.Messages.Type.RESPONSE,
                                    Entity = entities
                                };
