...
{
    [AllowAnonymous]
    public class Services2Section3DownloadMasterController : BaseController
    {
        ...
        private Business.Interface.IServices2Section3DownloadMaster businessServices2Section3DownloadMaster;
        private Business.Interface.IServices2Master businessServices2Master;

        public Services2Section3DownloadMasterController(Business.Interface.IMessage Imessage, Business.Interface.IServices2Section3DownloadMaster IServices2Section3DownloadMaster, Business.Interface.IServices2Master IServices2Master)
        {
            this.businessMessage = Imessage;
            this.businessServices2Section3DownloadMaster = IServices2Section3DownloadMaster;
        ...
        [Route("Configurations/Master/ServiceType2/Section3")]
        [Route("Settings/Master/ServiceType2/Section3")]
        ...
        [HttpPost]
        [Route("Post/Services2Section3Download/IndexAsync")]
        [ValidateAntiForgeryTokens]
        public async Task<ActionResult> IndexAsync()
        {
            BusinessResultViewModel<ViewModel.Services2Section3DownloadMasterIndexViewModel> businessResult;
            try
            {
                using (var transaction = new TransactionScope(TransactionScopeOption.Required, new TransactionOptions() { IsolationLevel = IsolationLevel.ReadUncommitted }))
                {
                    try
                    {
                        ...
                        businessResult = this.businessServices2Section3DownloadMaster.Index(Request, tenantId);
        ...
        [AuditAttribute]
        [ValidateAntiForgeryTokens]
        [Route("Post/Services2Section3DownloadMaster/CreateAsync")]
        public async Task<ActionResult> CreateAsync(ViewModel.Services2Section3DownloadMasterCreateOrEditViewModel model)
        {
            try
            {
                ...
                else
                {
                    using (var transaction = new TransactionScope())
                    {
                        try
                        {
                            var productId = businessServices2Section3DownloadMaster.FindBy(Services2Section3Download => Services2Section3Download.Tenant_ID == model.Tenant_ID && Services2Section3Download.ID == model.ID).FirstOrDefault();
                            ...
                            else
                            {
                                ...
                                var entity = new EntityModel.Services2Section3DownloadMaster();
                                entity.Tenant = null;
                                //entity.Services2Section3DownloadMasters = null;
                                ...
                                this.businessServices2Section3DownloadMaster.Create(entity);
                                transaction.Complete();
        ...
        [HttpGet]
        [Route("Get/Services2Section3DownloadMaster/EditAsync")]
            ...
            try
            {
                using (var transaction = new TransactionScope(TransactionScopeOption.Required, new TransactionOptions() { IsolationLevel = IsolationLevel.ReadUncommitted }))
                {
                    try
                    {
                        ...
                        {
                            var entity = this.businessServices2Section3DownloadMaster.GetById(Id);
                            ...
                            if (entity.IsNotNull())
                            {
                                ...
                                var model = new ViewModel.Services2Section3DownloadMasterCreateOrEditViewModel();
                                ...
                                var response = new JsonResponse<Services2Section3DownloadMasterCreateOrEditViewModel>()
                                {
                                    Type = busConstant.Messages.Type.RESPONSE,
                                    Entity = model
                                };
        ...
        [AuditAttribute]
        [ValidateAntiForgeryTokens]
        [Route("Post/Services2Section3DownloadMaster/EditAsync")]
        public async Task<ActionResult> EditAsync(ViewModel.Services2Section3DownloadMasterCreateOrEditViewModel model)
        {
            try
            {
                ...
                else
                {
                    using (var transaction = new TransactionScope())
                    {
                        try
                        {
                            var Services2Section3DownloadData = businessServices2Section3DownloadMaster.FindBy(Services2Section3Download => Services2Section3Download.Tenant_ID == model.Tenant_ID && Services2Section3Download.ID == model.ID).FirstOrDefault();
                            ...
                            {
                                var entityServices = this.businessServices2Master.FindBy(Services2Master => Services2Master.SubSubCat_Id == model.SubSubCat_Id).FirstOrDefault();
                                var entity = this.businessServices2Section3DownloadMaster.GetById(Convert.ToInt64(model.ID));
                                if (entity.IsNotNull())
                                {
                                    ...
                                    entity.SubSubCategoriesMaster = null;
                                    entity.Services2Master = null;
                                    this.businessServices2Section3DownloadMaster.Update(entity);
        ...
        [AuditAttribute]
        [ValidateAntiForgeryTokens]
        [Route("Post/Services2Section3DownloadMaster/Delete")]
            ...
            try
            {
                using (var transaction = new TransactionScope(TransactionScopeOption.Required, new TransactionOptions() { IsolationLevel = IsolationLevel.ReadUncommitted }))
                {
                    try
                    {
                        ...
                        {
                            this.businessServices2Section3DownloadMaster.Delete(Convert.ToInt64(Id));
        ...
        [HttpGet]
        [Route("Get/Services2Section3DownloadMaster/DropdownListbyTenantAsync")]
        public async Task<ActionResult> GetServices2Section3DownloadMasterByTenantIdAsync(long Id)
        {
            try
            {
                using (var transaction = new TransactionScope(TransactionScopeOption.Required, new TransactionOptions() { IsolationLevel = IsolationLevel.ReadUncommitted }))
                {
                    try
                    {
                        ...
                        {
                            var entities = this.businessServices2Section3DownloadMaster.FindBy(product => product.Tenant_ID == Id).Select(x => new ViewModel.Services2Section3DownloadMasterDropdownListViewModel
                            {
                                ID = x.ID,
                            ...
                            {
                                var response = new JsonResponse<IEnumerable<ViewModel.Services2Section3DownloadMasterDropdownListViewModel>>()
                                {
                                    Type = busConstant.Messages.Type.RESPONSE,
                                    Entity = entities
                                };
