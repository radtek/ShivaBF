...
{
    [AllowAnonymous]
    public class CommentsReplyController : BaseController
    {
        ...
        public CommentsReplyController(Business.Interface.IMessage Imessage, Business.Interface.ICommentsReply ICommentsReply, Business.Interface.IBlogMaster IBlogMaster)
        {
        ...
        [Route("Configurations/Master/Blog/CommentsReply")]
        [Route("Settings/Master/Blog/CommentsReply")]
        ...
        [HttpPost]
        [Route("Post/CommentsReply/IndexAsync")]
        [ValidateAntiForgeryTokens]
        public async Task<ActionResult> IndexAsync()
        {
            BusinessResultViewModel<ViewModel.CommentsReplyIndexViewModel> businessResult;
            try
            {
                using (var transaction = new TransactionScope(TransactionScopeOption.Required, new TransactionOptions() { IsolationLevel = IsolationLevel.ReadUncommitted }))
                {
                    try
                    {
                        ...
                        businessResult = this.businessCommentsReply.Index(Request, tenantId);
        ...
        [AuditAttribute]
        [ValidateAntiForgeryTokens]
        [Route("Post/CommentsReply/CreateAsync")]
        ...
        [HttpGet]
        [Route("Get/CommentsReply/EditAsync")]
            ...
            try
            {
                using (var transaction = new TransactionScope(TransactionScopeOption.Required, new TransactionOptions() { IsolationLevel = IsolationLevel.ReadUncommitted }))
                {
                    try
                    {
                        ...
                        {
                            var entity = this.businessCommentsReply.GetById(Id);

                            if (entity.IsNotNull())
                            {

                                var model = new ViewModel.CommentsReplyCreateOrEditViewModel();

                                // Mapper.Map(entity, model);

                                model.ID = entity.ID;
                                model.Blog_Id = entity.Blog_Id;
                                model.BCD_Id = entity.BCD_Id;
                                ...
                                var response = new JsonResponse<CommentsReplyCreateOrEditViewModel>()
                                {
                                    Type = busConstant.Messages.Type.RESPONSE,
                                    Entity = model
                                };
        ...
        [AuditAttribute]
        [ValidateAntiForgeryTokens]
        [Route("Post/CommentsReply/EditAsync")]
        public async Task<ActionResult> EditAsync(ViewModel.CommentsReplyCreateOrEditViewModel model)
        {
            try
            {
                ...
                else
                {
                    using (var transaction = new TransactionScope())
                    {
                        try
                        {
                            var Services1Section4Data = businessCommentsReply.FindBy(Services1Section4 => Services1Section4.Tenant_ID == model.Tenant_ID && Services1Section4.ID == model.ID).FirstOrDefault();
                            ...
                            else
                            {
                                ...
                                var entity = this.businessCommentsReply.GetById(Convert.ToInt64(model.ID));
                                if (entity.IsNotNull())
                                {
                                    entity.Tenant = null;
                                    entity.BlogMaster = null;
                                    ...
                                    this.businessCommentsReply.Update(entity);
        ...
        [AuditAttribute]
        [ValidateAntiForgeryTokens]
        [Route("Post/CommentsReply/Delete")]
            ...
            try
            {
                using (var transaction = new TransactionScope(TransactionScopeOption.Required, new TransactionOptions() { IsolationLevel = IsolationLevel.ReadUncommitted }))
                {
                    try
                    {
                        ...
                        {
                            this.businessCommentsReply.Delete(Convert.ToInt64(Id));
        ...
        [HttpGet]
        [Route("Get/CommentsReply/DropdownListbyTenantAsync")]
        public async Task<ActionResult> GetCommentsReplyByTenantIdAsync(long Id)
        {
            try
            {
                using (var transaction = new TransactionScope(TransactionScopeOption.Required, new TransactionOptions() { IsolationLevel = IsolationLevel.ReadUncommitted }))
                {
                    try
                    {
                        ...
                        {
                            var entities = this.businessCommentsReply.FindBy(product => product.Tenant_ID == Id).Select(x => new ViewModel.CommentsReplyDropdownListViewModel
                            {
                                ID = x.ID,
                                Blog_Id = x.Blog_Id.ToString()
                            });

                            if (entities.IsNotNull())
                            {
                                var response = new JsonResponse<IEnumerable<ViewModel.CommentsReplyDropdownListViewModel>>()
                                {
                                    Type = busConstant.Messages.Type.RESPONSE,
                                    Entity = entities
                                };
