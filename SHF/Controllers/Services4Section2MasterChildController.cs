...
{
    [AllowAnonymous]
    public class Services4Section2MasterChildController : BaseController
    {
        ...
        private Business.Interface.IServices4Section2MasterChild businessServices4Section2MasterChild;
        private Business.Interface.IServices4Master businessServices4Master;

        public Services4Section2MasterChildController(Business.Interface.IMessage Imessage, Business.Interface.IServices4Section2MasterChild IServices4Section2MasterChild, Business.Interface.IServices4Master IServices4Master)
        {
            this.businessMessage = Imessage;
            this.businessServices4Section2MasterChild = IServices4Section2MasterChild;
        ...
        [Route("Configurations/Master/ServiceType4/Section2Child")]
        [Route("Settings/Master/ServiceType4/Section2Child")]
        ...
        [HttpPost]
        [Route("Post/Services4Section2MasterChild/IndexAsync")]
        [ValidateAntiForgeryTokens]
        public async Task<ActionResult> IndexAsync()
        {
            BusinessResultViewModel<ViewModel.Services4Section2MasterChildIndexViewModel> businessResult;
            try
            {
                using (var transaction = new TransactionScope(TransactionScopeOption.Required, new TransactionOptions() { IsolationLevel = IsolationLevel.ReadUncommitted }))
                {
                    try
                    {
                        ...
                        businessResult = this.businessServices4Section2MasterChild.Index(Request, tenantId);
        ...
        [AuditAttribute]
        [ValidateAntiForgeryTokens]
        [Route("Post/Services4Section2MasterChild/CreateAsync")]
        public async Task<ActionResult> CreateAsync(ViewModel.Services4Section2MasterChildCreateOrEditViewModel model)
        {
            try
            {
                ...
                else
                {
                    using (var transaction = new TransactionScope())
                    {
                        try
                        {
                            var productId = businessServices4Section2MasterChild.FindBy(Services2Section4 => Services2Section4.Tenant_ID == model.Tenant_ID && Services2Section4.ID==model.ID).FirstOrDefault();
                            ...
                            else
                            {
                                ...
                                var entity = new EntityModel.Services4Section2MasterChild();
                                entity.Tenant = null;
                                //entity.Services4Section2MasterChilds = null;
                                ...
                                //Mapper.Map(model, entity);
                                 this.businessServices4Section2MasterChild.Create(entity);
                                transaction.Complete();
        ...
        [HttpGet]
        [Route("Get/Services4Section2MasterChild/EditAsync")]
            ...
            try
            {
                using (var transaction = new TransactionScope(TransactionScopeOption.Required, new TransactionOptions() { IsolationLevel = IsolationLevel.ReadUncommitted }))
                {
                    try
                    {
                        ...
                        {
                            var entity = this.businessServices4Section2MasterChild.GetById(Id);
                            ...
                            if (entity.IsNotNull())
                            {
                                ...
                                var model = new ViewModel.Services4Section2MasterChildCreateOrEditViewModel();
                                ...
                                var response = new JsonResponse<Services4Section2MasterChildCreateOrEditViewModel>()
                                {
                                    Type = busConstant.Messages.Type.RESPONSE,
                                    Entity = model
                                };
        ...
        [AuditAttribute]
        [ValidateAntiForgeryTokens]
        [Route("Post/Services4Section2MasterChild/EditAsync")]
        public async Task<ActionResult> EditAsync(ViewModel.Services4Section2MasterChildCreateOrEditViewModel model)
        {
            try
            {
                ...
                else
                {
                    using (var transaction = new TransactionScope())
                    {
                        try
                        {
                            var Services2Section4Data = businessServices4Section2MasterChild.FindBy(Services2Section4 => Services2Section4.Tenant_ID == model.Tenant_ID && Services2Section4.ID == model.ID).FirstOrDefault();
                            ...
                            else
                            {
                                ...
                                entity.SubSubCategoriesMaster = null;
                                entity.Services4Master = null;
                                this.businessServices4Section2MasterChild.Update(entity);
        ...
        [AuditAttribute]
        [ValidateAntiForgeryTokens]
        [Route("Post/Services4Section2MasterChild/Delete")]
            ...
            try
            {
                using (var transaction = new TransactionScope(TransactionScopeOption.Required, new TransactionOptions() { IsolationLevel = IsolationLevel.ReadUncommitted }))
                {
                    try
                    {
                        ...
                        {
                            this.businessServices4Section2MasterChild.Delete(Convert.ToInt64(Id));
        ...
        [HttpGet]
        [Route("Get/Services4Section2MasterChild/DropdownListbyTenantAsync")]
        public async Task<ActionResult> GetServices4Section2MasterChildByTenantIdAsync(long Id)
        {
            try
            {
                using (var transaction = new TransactionScope(TransactionScopeOption.Required, new TransactionOptions() { IsolationLevel = IsolationLevel.ReadUncommitted }))
                {
                    try
                    {
                        ...
                        {
                            var entities = this.businessServices4Section2MasterChild.FindBy(product => product.Tenant_ID == Id).Select(x => new ViewModel.Services4Section2MasterChildDropdownListViewModel
                            {
                                ID = x.ID,
                            ...
                            {
                                var response = new JsonResponse<IEnumerable<ViewModel.Services4Section2MasterChildDropdownListViewModel>>()
                                {
                                    Type = busConstant.Messages.Type.RESPONSE,
                                    Entity = entities
                                };
