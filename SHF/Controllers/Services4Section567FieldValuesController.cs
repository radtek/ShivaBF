...
{
    [AllowAnonymous]
    public class Services4Section567FieldValuesController : BaseController
    {
        ...
        private Business.Interface.IServices4Section567FieldValues businessServices4Section567FieldValues;
        private Business.Interface.IServices4Master businessServices4Master;

        public Services4Section567FieldValuesController(Business.Interface.IMessage Imessage, Business.Interface.IServices4Section567FieldValues IServices4Section567FieldValues, Business.Interface.IServices4Master IServices4Master)
        {
            this.businessMessage = Imessage;
            this.businessServices4Section567FieldValues = IServices4Section567FieldValues;
        ...
        [Route("Configurations/Master/ServiceType4/Section567FieldValues")]
        [Route("Settings/Master/ServiceType4/Section567FieldValues")]
        ...
        [HttpPost]
        [Route("Post/Services4Section567FieldValues/IndexAsync")]
        [ValidateAntiForgeryTokens]
        public async Task<ActionResult> IndexAsync()
        {
            BusinessResultViewModel<ViewModel.Services4Section567FieldValuesIndexViewModel> businessResult;
            try
            {
                using (var transaction = new TransactionScope(TransactionScopeOption.Required, new TransactionOptions() { IsolationLevel = IsolationLevel.ReadUncommitted }))
                {
                    try
                    {
                        ...
                        businessResult = this.businessServices4Section567FieldValues.Index(Request, tenantId);
        ...
        [AuditAttribute]
        [ValidateAntiForgeryTokens]
        [Route("Post/Services4Section567FieldValues/CreateAsync")]
        public async Task<ActionResult> CreateAsync(ViewModel.Services4Section567FieldValuesCreateOrEditViewModel model)
        {
            try
            {
                    ...
                    using (var transaction = new TransactionScope())
                    {
                        try
                        {
                            ...
                            else
                            {
                                ...
                                var entity = new EntityModel.Services4Section567FieldValues();
                                entity.Tenant = null;
                                //entity.Services4Section567FieldValuess = null;
        ...
        [HttpGet]
        [Route("Get/Services4Section567FieldValues/EditAsync")]
            ...
            try
            {
                using (var transaction = new TransactionScope(TransactionScopeOption.Required, new TransactionOptions() { IsolationLevel = IsolationLevel.ReadUncommitted }))
                {
                    try
                    {
                        ...
                        {
                            var entity = this.businessServices4Section567FieldValues.GetById(Id);
                            ...
                            if (entity.IsNotNull())
                            {
                                ...
                                var model = new ViewModel.Services4Section567FieldValuesCreateOrEditViewModel();
        ...
        [AuditAttribute]
        [ValidateAntiForgeryTokens]
        [Route("Post/Services4Section567FieldValues/EditAsync")]
        public async Task<ActionResult> EditAsync(ViewModel.Services4Section567FieldValuesCreateOrEditViewModel model)
        {
            try
            {
                ...
                else
                {
                    using (var transaction = new TransactionScope())
                    {
                        try
                        {
                            var Services2Section4Data = businessServices4Section567FieldValues.FindBy(Services2Section4 => Services2Section4.Tenant_ID == model.Tenant_ID && Services2Section4.ID == model.ID).FirstOrDefault();
                            ...
                            else
                            {
                                ...
                                if (entity.isNotNull())
                                {
                                    ...
                                    entity.SubSubCategoriesMaster = null;
                                    entity.Services4Master = null;
                                    this.businessServices4Section567FieldValues.Update(entity);
        ...
        [AuditAttribute]
        [ValidateAntiForgeryTokens]
        [Route("Post/Services4Section567FieldValues/Delete")]
            ...
            try
            {
                using (var transaction = new TransactionScope(TransactionScopeOption.Required, new TransactionOptions() { IsolationLevel = IsolationLevel.ReadUncommitted }))
                {
                    try
                    {
                        ...
                        {
                            this.businessServices4Section567FieldValues.Delete(Convert.ToInt64(Id));
        ...
        [HttpGet]
        [Route("Get/Services4Section567FieldValues/DropdownListbyTenantAsync")]
        public async Task<ActionResult> GetServices4Section567FieldValuesByTenantIdAsync(long Id)
        {
            try
            {
                using (var transaction = new TransactionScope(TransactionScopeOption.Required, new TransactionOptions() { IsolationLevel = IsolationLevel.ReadUncommitted }))
                {
                    try
                    {
                        ...
                        else
                        {
                            ...
                            {
                                var response = new JsonResponse<IEnumerable<ViewModel.Services4Section567FieldValuesDropdownListViewModel>>()
                                {
                                    Type = busConstant.Messages.Type.RESPONSE,
                                    Entity = entities
                                };
