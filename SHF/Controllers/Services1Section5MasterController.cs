...
namespace SHF.Controllers
{
    ...
    public class Services1Section5MasterController : BaseController
    {
        ...
        [Route("Configurations/Master/Services1Section5/Index")]
        [Route("Settings/Master/Services1Section5/Index")]
            ...
            try
            {
                using (var transaction = new TransactionScope(TransactionScopeOption.Required, new TransactionOptions() { IsolationLevel = IsolationLevel.ReadUncommitted }))
                {
                    try
                    {
                        ...
                        {
                            var entities = this.businessServices1Section5Master.FindBy(product => product.Tenant_ID == Id).Select(x => new ViewModel.Services1Section5DropdownListViewModel
                            {
                                ID = x.ID,
                            ...
                            {
                                var response = new JsonResponse<IEnumerable<ViewModel.Services1Section5DropdownListViewModel>>()
                                {
                                    Type = busConstant.Messages.Type.RESPONSE,
                                    Entity = entities
                                };
