...
{
    [AllowAnonymous]
    public class Services1Section5MasterController : BaseController
    {
        ...
        private Business.Interface.IServices1Section5Master businessServices1Section5Master;
        private Business.Interface.IServices1Master businessServices1Master;

        public Services1Section5MasterController(Business.Interface.IMessage Imessage, Business.Interface.IServices1Section5Master IServices1Section5Master, Business.Interface.IServices1Master IServices1Master)
        {
            this.businessMessage = Imessage;
            this.businessServices1Section5Master = IServices1Section5Master;
        ...
        [Route("Configurations/Master/ServiceType1/Section5")]
        [Route("Settings/Master/ServiceType1/Section5")]
        ...
        [HttpPost]
        [Route("Post/Services1Section5/IndexAsync")]
        [ValidateAntiForgeryTokens]
        public async Task<ActionResult> IndexAsync()
        {
            BusinessResultViewModel<ViewModel.Services1Section5MasterIndexViewModel> businessResult;
            try
            {
                using (var transaction = new TransactionScope(TransactionScopeOption.Required, new TransactionOptions() { IsolationLevel = IsolationLevel.ReadUncommitted }))
                {
                    try
                    {
                        ...
                        businessResult = this.businessServices1Section5Master.Index(Request, tenantId);
        ...
        [AuditAttribute]
        [ValidateAntiForgeryTokens]
        [Route("Post/Services1Section5Master/CreateAsync")]
        public async Task<ActionResult> CreateAsync(ViewModel.Services1Section5MasterCreateOrEditViewModel model)
        {
            try
            {
                ...
                else
                {
                    using (var transaction = new TransactionScope())
                    {
                        try
                        {
                            var productId = businessServices1Section5Master.FindBy(Services1Section5 => Services1Section5.Tenant_ID == model.Tenant_ID && Services1Section5.ID == model.ID).FirstOrDefault();
                            ...
                            else
                            {
                                ...
                                var entity = new EntityModel.Services1Section5Master();
                                entity.Tenant = null;
                                ...
                                this.businessServices1Section5Master.Create(entity);
                                transaction.Complete();
        ...
        [HttpGet]
        [Route("Get/Services1Section5Master/EditAsync")]
            ...
            try
            {
                using (var transaction = new TransactionScope(TransactionScopeOption.Required, new TransactionOptions() { IsolationLevel = IsolationLevel.ReadUncommitted }))
                {
                    try
                    {
                        ...
                        {
                            var entity = this.businessServices1Section5Master.GetById(Id);
                            ...
                            if (entity.IsNotNull())
                            {
                                ...
                                var model = new ViewModel.Services1Section5MasterCreateOrEditViewModel();
                                ...
                                var response = new JsonResponse<Services1Section5MasterCreateOrEditViewModel>()
                                {
                                    Type = busConstant.Messages.Type.RESPONSE,
                                    Entity = model
                                };
        ...
        [AuditAttribute]
        [ValidateAntiForgeryTokens]
        [Route("Post/Services1Section5Master/EditAsync")]
        public async Task<ActionResult> EditAsync(ViewModel.Services1Section5MasterCreateOrEditViewModel model)
        {
            try
            {
                ...
                else
                {
                    using (var transaction = new TransactionScope())
                    {
                        try
                        {
                            var Services1Section5Data = businessServices1Section5Master.FindBy(Services1Section5 => Services1Section5.Tenant_ID == model.Tenant_ID && Services1Section5.ID == model.ID).FirstOrDefault();

                            if (Services1Section5Data.IsNull())
                            {
                                transaction.Complete();
                                var response = new JsonResponse<dynamic>()
                                {
                            ...
                            {
                                var entityServices = this.businessServices1Master.FindBy(services1master => services1master.SubSubCat_Id == model.SubSubCat_Id).FirstOrDefault();
                                var entity = this.businessServices1Section5Master.GetById(Convert.ToInt64(model.ID));
                                if (entity.IsNotNull())
                                {
                                    entity.Tenant = null;
                                    entity.SubSubCategoriesMaster = null;
                                    ...
                                    entity.Tenant_ID = model.Tenant_ID;
                                    //Mapper.Map(model, entity);
                                    this.businessServices1Section5Master.Update(entity);
        ...
        [AuditAttribute]
        [ValidateAntiForgeryTokens]
        [Route("Post/Services1Section5Master/Delete")]
            ...
            try
            {
                using (var transaction = new TransactionScope(TransactionScopeOption.Required, new TransactionOptions() { IsolationLevel = IsolationLevel.ReadUncommitted }))
                {
                    try
                    {
                        ...
                        {
                            this.businessServices1Section5Master.Delete(Convert.ToInt64(Id));
        ...
        [HttpGet]
        [Route("Get/Services1Section5Master/DropdownListbyTenantAsync")]
        public async Task<ActionResult> GetServices1Section5MasterByTenantIdAsync(long Id)
        {
            try
            {
                using (var transaction = new TransactionScope(TransactionScopeOption.Required, new TransactionOptions() { IsolationLevel = IsolationLevel.ReadUncommitted }))
                {
                    try
                    {
                        ...
                        {
                            var entities = this.businessServices1Section5Master.FindBy(product => product.Tenant_ID == Id).Select(x => new ViewModel.Services1Section5MasterDropdownListViewModel
                            {
                                ID = x.ID,
                            ...
                            {
                                var response = new JsonResponse<IEnumerable<ViewModel.Services1Section5MasterDropdownListViewModel>>()
                                {
                                    Type = busConstant.Messages.Type.RESPONSE,
                                    Entity = entities
                                };
