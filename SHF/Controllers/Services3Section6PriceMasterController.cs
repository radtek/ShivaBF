...
{
    [AllowAnonymous]
    public class Services3Section6PriceMasterController : BaseController
    {
        ...
        private Business.Interface.IServices3Section6PriceMaster businessServices3Section6PriceMaster;
        private Business.Interface.IServices3Master businessServices3Master;

        public Services3Section6PriceMasterController(Business.Interface.IMessage Imessage, Business.Interface.IServices3Section6PriceMaster IServices3Section6PriceMaster, Business.Interface.IServices3Master IServices3Master)
        {
            this.businessMessage = Imessage;
            this.businessServices3Section6PriceMaster = IServices3Section6PriceMaster;
        ...
        [Route("Configurations/Master/ServiceType3/Section6")]
        [Route("Settings/Master/ServiceType3/Section6")]
        ...
        [HttpPost]
        [Route("Post/Services3Section6PriceMaster/IndexAsync")]
        [ValidateAntiForgeryTokens]
        public async Task<ActionResult> IndexAsync()
        {
            BusinessResultViewModel<ViewModel.Services3Section6PriceMasterIndexViewModel> businessResult;
            try
            {
                using (var transaction = new TransactionScope(TransactionScopeOption.Required, new TransactionOptions() { IsolationLevel = IsolationLevel.ReadUncommitted }))
                {
                    try
                    {
                        ...
                        businessResult = this.businessServices3Section6PriceMaster.Index(Request, tenantId);
        ...
        [AuditAttribute]
        [ValidateAntiForgeryTokens]
        [Route("Post/Services3Section6PriceMaster/CreateAsync")]
        public async Task<ActionResult> CreateAsync(ViewModel.Services3Section6PriceMasterCreateOrEditViewModel model)
        {
            try
            {
                ...
                else
                {
                    using (var transaction = new TransactionScope())
                    {
                        try
                        {
                            var productId = businessServices3Section6PriceMaster.FindBy(Services2Section4 => Services2Section4.Tenant_ID == model.Tenant_ID && Services2Section4.ID == model.ID).FirstOrDefault();
                            ...
                            else
                            {
                                ...
                                var entity = new EntityModel.Services3Section6PriceMaster();
                                entity.Tenant = null;
                                ...
                                this.businessServices3Section6PriceMaster.Create(entity);
                                transaction.Complete();
        ...
        [HttpGet]
        [Route("Get/Services3Section6PriceMaster/EditAsync")]
            ...
            try
            {
                using (var transaction = new TransactionScope(TransactionScopeOption.Required, new TransactionOptions() { IsolationLevel = IsolationLevel.ReadUncommitted }))
                {
                    try
                    {
                        ...
                        {
                            var entity = this.businessServices3Section6PriceMaster.GetById(Id);
                            ...
                            if (entity.IsNotNull())
                            {
                                ...
                                var model = new ViewModel.Services3Section6PriceMasterCreateOrEditViewModel();
                                ...
                                var response = new JsonResponse<Services3Section6PriceMasterCreateOrEditViewModel>()
                                {
                                    Type = busConstant.Messages.Type.RESPONSE,
                                    Entity = model
                                };
        ...
        [AuditAttribute]
        [ValidateAntiForgeryTokens]
        [Route("Post/Services3Section6PriceMaster/EditAsync")]
        public async Task<ActionResult> EditAsync(ViewModel.Services3Section6PriceMasterCreateOrEditViewModel model)
        {
            try
            {
                ...
                else
                {
                    using (var transaction = new TransactionScope())
                    {
                        try
                        {
                            var Services2Section4Data = businessServices3Section6PriceMaster.FindBy(Services2Section4 => Services2Section4.Tenant_ID == model.Tenant_ID && Services2Section4.ID == model.ID).FirstOrDefault();
                            ...
                            {
                                var entityServices = this.businessServices3Master.FindBy(Services3Master => Services3Master.SubSubCat_Id == model.SubSubCat_Id).FirstOrDefault();
                                var entity = this.businessServices3Section6PriceMaster.GetById(Convert.ToInt64(model.ID));
                                if (entity.IsNotNull())
                                {
        ...
        [AuditAttribute]
        [ValidateAntiForgeryTokens]
        [Route("Post/Services3Section6PriceMaster/Delete")]
            ...
            try
            {
                using (var transaction = new TransactionScope(TransactionScopeOption.Required, new TransactionOptions() { IsolationLevel = IsolationLevel.ReadUncommitted }))
                {
                    try
                    {
                        ...
                        {
                            this.businessServices3Section6PriceMaster.Delete(Convert.ToInt64(Id));
        ...
        [HttpGet]
        [Route("Get/Services3Section6PriceMaster/DropdownListbyTenantAsync")]
        public async Task<ActionResult> GetServices3Section6PriceMasterByTenantIdAsync(long Id)
        {
            try
            {
                using (var transaction = new TransactionScope(TransactionScopeOption.Required, new TransactionOptions() { IsolationLevel = IsolationLevel.ReadUncommitted }))
                {
                    try
                    {
                        ...
                        {
                            var entities = this.businessServices3Section6PriceMaster.FindBy(product => product.Tenant_ID == Id).Select(x => new ViewModel.Services3Section6PriceMasterDropdownListViewModel
                            {
                                ID = x.ID,
                            ...
                            {
                                var response = new JsonResponse<IEnumerable<ViewModel.Services3Section6PriceMasterDropdownListViewModel>>()
                                {
                                    Type = busConstant.Messages.Type.RESPONSE,
                                    Entity = entities
                                };
