...
{
    [AllowAnonymous]
    public class Services4Section567FieldMasterController : BaseController
    {
        ...
        private Business.Interface.IServices4Section567FieldMaster businessServices4Section567FieldMaster;
        private Business.Interface.IServices4Master businessServices4Master;

        public Services4Section567FieldMasterController(Business.Interface.IMessage Imessage, Business.Interface.IServices4Section567FieldMaster IServices4Section567FieldMaster, Business.Interface.IServices4Master IServices4Master)
        {
            this.businessMessage = Imessage;
            this.businessServices4Section567FieldMaster = IServices4Section567FieldMaster;
        ...
        [Route("Configurations/Master/ServiceType4/Section567FieldMaster")]
        [Route("Settings/Master/ServiceType4/Section567FieldMaster")]
        ...
        [HttpPost]
        [Route("Post/Services4Section567FieldMaster/IndexAsync")]
        [ValidateAntiForgeryTokens]
        public async Task<ActionResult> IndexAsync()
        {
            BusinessResultViewModel<ViewModel.Services4Section567FieldMasterIndexViewModel> businessResult;
            try
            {
                using (var transaction = new TransactionScope(TransactionScopeOption.Required, new TransactionOptions() { IsolationLevel = IsolationLevel.ReadUncommitted }))
                {
                    try
                    {
                        ...
                        businessResult = this.businessServices4Section567FieldMaster.Index(Request, tenantId);
        ...
        [AuditAttribute]
        [ValidateAntiForgeryTokens]
        [Route("Post/Services4Section567FieldMaster/CreateAsync")]
        public async Task<ActionResult> CreateAsync(ViewModel.Services4Section567FieldMasterCreateOrEditViewModel model)
        {
            try
            {
                    ...
                    using (var transaction = new TransactionScope())
                    {
                        try
                        {
                            ...
                            else
                            {
                                ...
                                var entity = new EntityModel.Services4Section567FieldMaster();
                                entity.Tenant = null;
                                //entity.Services4Section567FieldMasters = null;
        ...
        [HttpGet]
        [Route("Get/Services4Section567FieldMaster/EditAsync")]
            ...
            try
            {
                using (var transaction = new TransactionScope(TransactionScopeOption.Required, new TransactionOptions() { IsolationLevel = IsolationLevel.ReadUncommitted }))
                {
                    try
                    {
                        ...
                        {
                            var entity = this.businessServices4Section567FieldMaster.GetById(Id);
                            ...
                            if (entity.IsNotNull())
                            {
                                ...
                                var model = new ViewModel.Services4Section567FieldMasterCreateOrEditViewModel();
        ...
        [AuditAttribute]
        [ValidateAntiForgeryTokens]
        [Route("Post/Services4Section567FieldMaster/EditAsync")]
        public async Task<ActionResult> EditAsync(ViewModel.Services4Section567FieldMasterCreateOrEditViewModel model)
        {
            try
            {
                ...
                else
                {
                    using (var transaction = new TransactionScope())
                    {
                        try
                        {
                            var Services2Section3DownloadData = businessServices4Section567FieldMaster.FindBy(Services2Section3Download => Services2Section3Download.Tenant_ID == model.Tenant_ID && Services2Section3Download.ID == model.ID).FirstOrDefault();
                            ...
                            else
                            {
                                ...
                                if (entity.isNotNull())
                                {
                                    ...
                                    entity.SubSubCategoriesMaster = null;
                                    entity.Services4Master = null;
                                    this.businessServices4Section567FieldMaster.Update(entity);
        ...
        [AuditAttribute]
        [ValidateAntiForgeryTokens]
        [Route("Post/Services4Section567FieldMaster/Delete")]
            ...
            try
            {
                using (var transaction = new TransactionScope(TransactionScopeOption.Required, new TransactionOptions() { IsolationLevel = IsolationLevel.ReadUncommitted }))
                {
                    try
                    {
                        ...
                        {
                            this.businessServices4Section567FieldMaster.Delete(Convert.ToInt64(Id));
        ...
        [HttpGet]
        [Route("Get/Services4Section567FieldMaster/DropdownListbyTenantAsync")]
        public async Task<ActionResult> GetServices4Section567FieldMasterByTenantIdAsync(long Id)
        {
            try
            {
                using (var transaction = new TransactionScope(TransactionScopeOption.Required, new TransactionOptions() { IsolationLevel = IsolationLevel.ReadUncommitted }))
                {
                    try
                    {
                        ...
                        {
                            var entities = this.businessServices4Section567FieldMaster.FindBy(product => product.Tenant_ID == Id).Select(x => new ViewModel.Services4Section567FieldMasterDropdownListViewModel
                            {
                                ID = x.ID,
                            ...
                            {
                                var response = new JsonResponse<IEnumerable<ViewModel.Services4Section567FieldMasterDropdownListViewModel>>()
                                {
                                    Type = busConstant.Messages.Type.RESPONSE,
                                    Entity = entities
                                };
