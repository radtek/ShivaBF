...
namespace SHF.Controllers
{
    ...
    public class CustomerMasterController : BaseController
    {
        ...
        public CustomerMasterController(Business.Interface.IMessage Imessage, Business.Interface.ICustomerMaster ICustomerMaster)
        {
        ...
        {
            BusinessResultViewModel<ViewModel.CustomerMasterIndexViewModel> businessResult;
            try
            {
                using (var transaction = new TransactionScope(TransactionScopeOption.Required, new TransactionOptions() { IsolationLevel = IsolationLevel.ReadUncommitted }))
                {
                    try
                    {
                        ...
                        businessResult = this.businessCustomerMaster.Index(Request, tenantId);
        ...
        public async Task<ActionResult> CreateAsync(ViewModel.CustomerMasterCreateOrEditViewModel model)
        {
            try
            {
                ...
                else
                {
                    using (var transaction = new TransactionScope())
                    {
                        try
                        {
                            var CustomerMasterId = businessCustomerMaster.FindBy(Customer => Customer.Tenant_ID == model.Tenant_ID && Customer.ID == model.ID).FirstOrDefault();

                            if (CustomerMasterId.IsNotNull())
                            {
                                transaction.Complete();
            ...
            try
            {
                using (var transaction = new TransactionScope(TransactionScopeOption.Required, new TransactionOptions() { IsolationLevel = IsolationLevel.ReadUncommitted }))
                {
                    try
                    {
                        ...
                        {
                            var entity = this.businessCustomerMaster.GetById(Id);

                            if (entity.IsNotNull())
                            {
                                var model = new ViewModel.CustomerMasterCreateOrEditViewModel();
                                model.ID = entity.ID;
                                ...
                                var response = new JsonResponse<CustomerMasterCreateOrEditViewModel>()
                                {
                                    Type = busConstant.Messages.Type.RESPONSE,
                                    Entity = model
                                };
        ...
        public async Task<ActionResult> EditAsync(ViewModel.CustomerMasterCreateOrEditViewModel model)
        {
            try
            {
                ...
                else
                {
                    using (var transaction = new TransactionScope())
                    {
                        try
                        {
                            var CustomerData = businessCustomerMaster.FindBy(Customer => Customer.Tenant_ID == model.Tenant_ID && Customer.ID == model.ID).FirstOrDefault();
                            ...
                            {
                                var entity = this.businessCustomerMaster.GetById(Convert.ToInt64(model.ID));
                                if (entity.IsNotNull())
                                {
                                    ...
                                    this.businessCustomerMaster.Update(entity);
            ...
            try
            {
                using (var transaction = new TransactionScope(TransactionScopeOption.Required, new TransactionOptions() { IsolationLevel = IsolationLevel.ReadUncommitted }))
                {
                    try
                    {
                        ...
                        {
                            this.businessCustomerMaster.Delete(Convert.ToInt64(Id));
        ...
        [HttpGet]
        [Route("Get/CustomerMaster/DropdownListbyTenantAsync")]
        public async Task<ActionResult> GetCustomerMasterByTenantIdAsync(long Id)
        {
            try
            {
                using (var transaction = new TransactionScope(TransactionScopeOption.Required, new TransactionOptions() { IsolationLevel = IsolationLevel.ReadUncommitted }))
                {
                    try
                    {
                        ...
                        {
                            var entities = this.businessCustomerMaster.GetAll().Where(Customer => Customer.Tenant_ID == Id).Select(x => new ViewModel.CustomerMasterDropdownListViewModel
                            {
                                ID = x.ID,
                            ...
                            {
                                var response = new JsonResponse<IEnumerable<ViewModel.CustomerMasterDropdownListViewModel>>()
                                {
                                    Type = busConstant.Messages.Type.RESPONSE,
                                    Entity = entities
                                };
        ...
        [HttpGet]
        [Route("Get/CustomerMaster/GetAllCustomerMasterByTenantIdAsync")]
        public async Task<ActionResult> GetAllCustomerMasterByTenantIdAsync(long Id)
        {
            try
            {
                using (var transaction = new TransactionScope(TransactionScopeOption.Required, new TransactionOptions() { IsolationLevel = IsolationLevel.ReadUncommitted }))
                {
                    try
                    {
                        ...
                        {
                            var entities = this.businessCustomerMaster.GetAll().Where(Customer => Customer.Tenant_ID == Id).Select(x => new ViewModel.CustomerMasterIndexViewModel
                            {
                                ID = x.ID,
                                FirstName = x.FirstName + " " + x.LastName
                            ...
                            if (entities.IsNotNull())
                            {
                                var response = new JsonResponse<IEnumerable<ViewModel.CustomerMasterIndexViewModel>>()
                                {
                                    Type = busConstant.Messages.Type.RESPONSE,
                                    Entity = entities
                                };
