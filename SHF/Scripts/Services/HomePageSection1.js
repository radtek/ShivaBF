...
angular.module(config.app).service('HomePageSection1CRUD', function ($http) {

    this.GetTableObject = function TableData() {
        let scope = angular.element(document.getElementById('HomePageSection1ControllerScope')).scope();
        let tenantId = scope.HomePageSection1CreateOrEditViewModel.Tenant_ID == null ? 0 : scope.HomePageSection1CreateOrEditViewModel.Tenant_ID;
        ...
        let oTable = $('#grdTable').DataTable({
            serverSide: true,
            ajax: {
                url: '/Post/HomePageSection1/IndexAsync',
                type: 'POST',
                dataSrc: 'data',
            ...
            columns: [
                ...
                {
                    name: "HomePageSection1.BannerImagePath",
                ...
                {
                    name: "HomePageSection1.ShortDescription",
                ...
                {
                    name: "HomePageSection1.LongtDescription",
                    data: "LongtDescription",
                    title: "LongtDescription",
                    render: $.fn.dataTable.render.text(),
                    width: "25%",
                    targets: 5
                },
                ...
                {
                    name: "HomePageSection1.AncharTagTitle",
                    data: "AncharTagTitle",
                ...
                {
                    name: "HomePageSection1.AncharTagUrl",
                    data: "AncharTagUrl",
                    title: "AncharTagUrl",
                    render: $.fn.dataTable.render.text(),
                    width: "25%",
                 ...
                 {
                     name: "HomePageSection1.DisplayIndex",
                     data: "DisplayIndex",
                     title: "Display&nbsp;Index",
                     render: $.fn.dataTable.render.text(),
                     width: "25%",
                ...
                {
                    name: "HomePageSection1.Metadata",
                    data: "Metadata",
                    title: "Metadata",
                    render: $.fn.dataTable.render.text(),
                    width: "25%",
                ...
                {
                    name: "HomePageSection1.MetaDescription",
                ...
                {
                    name: "HomePageSection1.TotalViews",
                    data: "TotalViews",
                    title: "TotalViews",
                    render: $.fn.dataTable.render.text(),
                    width: "25%",
              ...
              {
                  name: "HomePageSection1.IsActive",
                  data: "IsActive",
                  title: "Is&nbsp;Active",
                  render: $.fn.dataTable.render.text(),
                  width: "25%",
                ...
                {
                    name: "HomePageSection1.CreatedBy",
                    data: "CreatedBy",
                    title: "Created&nbsp;By",
                    render: $.fn.dataTable.render.text(),
                    width: "6%",
                ...
                {
                    name: "HomePageSection1.CreatedOn",
                    data: "CreatedOn",
                    title: "Created&nbsp;On",
                    render: function (data, type, row, meta) {
                ...
                {
                    name: "HomePageSection1.UpdatedBy",
                    data: "UpdatedBy",
                    title: "Modified&nbsp;By",
                    render: $.fn.dataTable.render.text(),
                    width: "6%",
                ...
                {
                    name: "HomePageSection1.UpdatedOn",
                    data: "UpdatedOn",
                    title: "Modified&nbsp;On",
                    render: function (data, type, row, meta) {
                        let date = new Date(parseInt(data.replace('/Date(', '')));
    ...
    this.LoadSubSubCategoriesDropdown = function SubSubCategoriesDropdown(tenantId) {
        let request = $http({
            method: "get",
            url: "/Get/HomePageSection1/DropdownListbyTenantAsync?Id=" + tenantId
        });
        return request;
    }
