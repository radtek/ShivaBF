...
angular.module(config.app).service('PriceFeaturesMapping_tenant_PriceFeaturesMaster_Services1Master_Services1Section6PriceMaster.PriceFeaturesMapping_tenant_PriceFeaturesMaster_Services1Master.PriceFeaturesMapping_tenant_PriceFeaturesMaster.PriceFeaturesMapping_tenant.PriceFeaturesMappingMappingCRUD', function ($http) {

    this.GetTableObject = function TableData() {
        let scope = angular.element(document.getElementById('PriceFeaturesMapping_tenant_PriceFeaturesMaster_Services1Master_Services1Section6PriceMaster.PriceFeaturesMapping_tenant_PriceFeaturesMaster_Services1Master.PriceFeaturesMapping_tenant_PriceFeaturesMaster.PriceFeaturesMapping_tenant.PriceFeaturesMappingMappingControllerScope')).scope();
        let tenantId = scope.PriceFeaturesMapping_tenant_PriceFeaturesMaster_Services1Master_Services1Section6PriceMaster.PriceFeaturesMapping_tenant_PriceFeaturesMaster_Services1Master.PriceFeaturesMapping_tenant_PriceFeaturesMaster.PriceFeaturesMapping_tenant.PriceFeaturesMappingMappingCreateOrEditViewModel.Tenant_ID == null ? 0 : scope.PriceFeaturesMapping_tenant_PriceFeaturesMaster_Services1Master_Services1Section6PriceMaster.PriceFeaturesMapping_tenant_PriceFeaturesMaster_Services1Master.PriceFeaturesMapping_tenant_PriceFeaturesMaster.PriceFeaturesMapping_tenant.PriceFeaturesMappingMappingCreateOrEditViewModel.Tenant_ID;
        ...
        let oTable = $('#grdTable').DataTable({
            serverSide: true,
            ajax: {
                url: '/Post/PriceFeaturesMapping_tenant_PriceFeaturesMaster_Services1Master_Services1Section6PriceMaster.PriceFeaturesMapping_tenant_PriceFeaturesMaster_Services1Master.PriceFeaturesMapping_tenant_PriceFeaturesMaster.PriceFeaturesMapping_tenant.PriceFeaturesMappingMapping/IndexAsync',
                type: 'POST',
                dataSrc: 'data',
                ...
                },
{
    ...
    this.LoadPriceFeaturesMapping_tenant_PriceFeaturesMaster_Services1Master_Services1Section6PriceMaster.PriceFeaturesMapping_tenant_PriceFeaturesMaster_Services1Master.PriceFeaturesMapping_tenant_PriceFeaturesMaster.PriceFeaturesMapping_tenant.PriceFeaturesMappingDropdown = function PriceFeaturesMapping_tenant_PriceFeaturesMaster_Services1Master_Services1Section6PriceMaster.PriceFeaturesMapping_tenant_PriceFeaturesMaster_Services1Master.PriceFeaturesMapping_tenant_PriceFeaturesMaster.PriceFeaturesMapping_tenant.PriceFeaturesMappingDropdown(tenantId) {
        let request = $http({
            method: "get",
            url: "/Get/PriceFeaturesMapping_tenant_PriceFeaturesMaster_Services1Master_Services1Section6PriceMaster.PriceFeaturesMapping_tenant_PriceFeaturesMaster_Services1Master.PriceFeaturesMapping_tenant_PriceFeaturesMaster.PriceFeaturesMapping_tenant.PriceFeaturesMappingMapping/DropdownListbyTenantAsync?Id=" + tenantId
        });
        return request;
    }
    ...
    this.LoadPurchaseProductDropdown = function PurchaseProductDropdown(tenantId) {
        let request = $http({
            method: "get",
            url: "/Get/PriceFeaturesMapping_tenant_PriceFeaturesMaster_Services1Master_Services1Section6PriceMaster.PriceFeaturesMapping_tenant_PriceFeaturesMaster_Services1Master.PriceFeaturesMapping_tenant_PriceFeaturesMaster.PriceFeaturesMapping_tenant.PriceFeaturesMappingMapping/PurchaseDropdownListbyTenantAsync?Id=" + tenantId
        });
        return request;
    }
    ...
    this.LoadPurchaseProductDropdownByVendor = function PurchaseProductDropdownByVendor(vendorId) {
        let request = $http({
            method: "get",
            url: "/Get/PriceFeaturesMapping_tenant_PriceFeaturesMaster_Services1Master_Services1Section6PriceMaster.PriceFeaturesMapping_tenant_PriceFeaturesMaster_Services1Master.PriceFeaturesMapping_tenant_PriceFeaturesMaster.PriceFeaturesMapping_tenant.PriceFeaturesMappingMapping/PurchaseDropdownListbyVendorAsync?Id=" + vendorId
        });
        return request;
    }
    ...
    this.LoadSaleableProductDropdownByTenant = function SaleableProductDropdownByTenantId(tenantId) {
        let request = $http({
            method: "get",
            url: "/Get/PriceFeaturesMapping_tenant_PriceFeaturesMaster_Services1Master_Services1Section6PriceMaster.PriceFeaturesMapping_tenant_PriceFeaturesMaster_Services1Master.PriceFeaturesMapping_tenant_PriceFeaturesMaster.PriceFeaturesMapping_tenant.PriceFeaturesMappingMapping/SaleableProductDropdownListbyTenantAsync?Id=" + tenantId
        });
        return request;
    }
    ...
    this.LoadAllProductDropdownByVendorId = function AllProductDropdownByVendorId(vendorId) {
        let request = $http({
            method: "get",
            url: "/Get/PriceFeaturesMapping_tenant_PriceFeaturesMaster_Services1Master_Services1Section6PriceMaster.PriceFeaturesMapping_tenant_PriceFeaturesMaster_Services1Master.PriceFeaturesMapping_tenant_PriceFeaturesMaster.PriceFeaturesMapping_tenant.PriceFeaturesMappingMapping/AllProductDropdownListByVendorAsync?Id=" + vendorId
        });
        return request;
    }
