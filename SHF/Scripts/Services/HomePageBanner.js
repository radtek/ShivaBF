...
angular.module(config.app).service('HomePageBannerCRUD', function ($http) {

    this.GetTableObject = function TableData() {
        let scope = angular.element(document.getElementById('HomePageBannerControllerScope')).scope();
        let tenantId = scope.HomePageBannerCreateOrEditViewModel.Tenant_ID == null ? 0 : scope.HomePageBannerCreateOrEditViewModel.Tenant_ID;
        ...
        let oTable = $('#grdTable').DataTable({
            serverSide: true,
            ajax: {
                url: '/Post/HomePageBanner/IndexAsync',
                type: 'POST',
                dataSrc: 'data',
            ...
            columns: [
                ...
                {
                    name: "HomePageBanner.BannerImagePath",
                ...
                {
                    name: "HomePageBanner.BannerOnHeading1",
                    data: "BannerOnHeading1",
                    title: "BannerOnHeading1",
                    render: $.fn.dataTable.render.text(),
                    width: "25%",
                    targets: 3
                },
                ...
                {
                    name: "HomePageBanner.BannerOnHeading2",
                    data: "BannerOnHeading2",
                    title: "BannerOnHeading2",
                    render: $.fn.dataTable.render.text(),
                    width: "25%",
                    targets: 5
                },
                {
                    name: "HomePageBanner.BannerHeadingDescription",
                ...
                {
                    name: "HomePageBanner.AncharTagTitle",
                    data: "AncharTagTitle",
                ...
                {
                    name: "HomePageBanner.AncharTagUrl",
                    data: "AncharTagUrl",
                    title: "AncharTagUrl",
                    render: $.fn.dataTable.render.text(),
                    width: "25%",
                 ...
                 {
                     name: "HomePageBanner.DisplayIndex",
                     data: "DisplayIndex",
                     title: "Display&nbsp;Index",
                     render: $.fn.dataTable.render.text(),
                     width: "25%",
                ...
                {
                    name: "HomePageBanner.MetaDescription",
                ...
                {
                    name: "HomePageBanner.TotalViews",
                    data: "TotalViews",
                    title: "TotalViews",
                    render: $.fn.dataTable.render.text(),
                    width: "25%",
    ...
    this.LoadSubSubCategoriesDropdown = function SubSubCategoriesDropdown(tenantId) {
        let request = $http({
            method: "get",
            url: "/Get/HomePageBanner/DropdownListbyTenantAsync?Id=" + tenantId
        });
        return request;
    }
