...
angular.module(config.app).service('Services1Section1MasterCRUD', function ($http) {

    this.GetTableObject = function TableData() {
        let scope = angular.element(document.getElementById('Services1Section1MasterControllerScope')).scope();
        let tenantId = scope.Services1Section1MasterCreateOrEditViewModel.Tenant_ID == null ? 0 : scope.Services1Section1MasterCreateOrEditViewModel.Tenant_ID;
        ...
        let oTable = $('#grdTable').DataTable({
            serverSide: true,
            ajax: {
                url: '/Post/Services1Section1/IndexAsync',
                type: 'POST',
                dataSrc: 'data',
            ...
            columns: [
                ...
                {
                    name: "Services1Section1Master_tenant.Services1Section1Master.ID",
                    data: "ID",
                    title: "ID",
                ...
                {
                    name: "Services1Section1Master_tenant.Services1Section1Master.AncharTagTitle",
                    data: "AncharTagTitle",
                 ...
                 {
                     name: "Services1Section1Master_tenant.Services1Section1Master.AncharTagUrl",
                     data: "AncharTagUrl",
               ...
               //   {
                ...
                //      render: $.fn.dataTable.render.text(),
                 ...
                 // },
                  {
                    name: "Services1Section1Master.SubSubCategoryName",
                ...
                {
                    name: "Services1Section1Master_tenant.Services1Section1Master.DisplayIndex",
                    data: "DisplayIndex",
                    title: "Display&nbsp;Index",
                    render: $.fn.dataTable.render.text(),
                    width: "25%",
 ...
 {
                    name: "Services1Section1Master_tenant.Services1Section1Master.Url",
                    data: "Url",
                    title: "Url",
                    render: $.fn.dataTable.render.text(),
                    width: "25%",
 ...
 {
                    name: "Services1Section1Master_tenant.Services1Section1Master.Metadata",
                    data: "Metadata",
                    title: "Metadata",
                    render: $.fn.dataTable.render.text(),
                    width: "25%",
...
{
                    name: "Services1Section1Master_tenant.Services1Section1Master.MetaDescription",
...
{
                    name: "Services1Section1Master_tenant.Services1Section1Master.Keyword",
                    data: "Keyword",
                    title: "Keyword",
                    render: $.fn.dataTable.render.text(),
                    width: "25%",
...
{
                    name: "Services1Section1Master_tenant.Services1Section1Master.TotalViews",
                    data: "TotalViews",
                    title: "TotalViews",
                    render: $.fn.dataTable.render.text(),
                    width: "25%",
              ...
              {
                    name: "Services1Section1Master_tenant.Services1Section1Master.IsActive",
                    data: "IsActive",
                    title: "Is&nbsp;Active",
                    render: $.fn.dataTable.render.text(),
                    width: "25%",
                ...
                {
                    name: "Services1Section1Master_tenant.Services1Section1Master.CreatedBy",
                    data: "CreatedBy",
                    title: "Created&nbsp;By",
                    render: $.fn.dataTable.render.text(),
                    width: "6%",
                ...
                {
                    name: "Services1Section1Master_tenant.Services1Section1Master.CreatedOn",
                    data: "CreatedOn",
                    title: "Created&nbsp;On",
                    render: function (data, type, row, meta) {
                ...
                {
                    name: "Services1Section1Master_tenant.Services1Section1Master.UpdatedBy",
                    data: "UpdatedBy",
                    title: "Modified&nbsp;By",
                    render: $.fn.dataTable.render.text(),
                    width: "6%",
                ...
                {
                    name: "Services1Section1Master_tenant.Services1Section1Master.UpdatedOn",
                    data: "UpdatedOn",
                    title: "Modified&nbsp;On",
                    render: function (data, type, row, meta) {
                        let date = new Date(parseInt(data.replace('/Date(', '')));
        ...
        $('#grdTable tbody').on('click', '.btn-preview', function () {
            let rowData = oTable.row($(this).parents('tr')).data();
            let scope = angular.element(document.getElementById('Services1Section1MasterControllerScope')).scope();
            scope.Preview('Views/services1.html?u='+rowData.ServiceUrl+'#divService1Section1Master');
        });
    }
