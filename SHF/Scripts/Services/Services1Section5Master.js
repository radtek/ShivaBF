...
angular.module(config.app).service('Services1Section5MasterCRUD', function ($http) {
    ...
    this.GetTableObject = function TableData() {
        ...
        let tenantId = scope.Services1Section5MasterCreateOrEditViewModel.Tenant_ID == null ? 0 : scope.Services1Section5MasterCreateOrEditViewModel.Tenant_ID;
        ...
        let oTable = $('#grdTable').DataTable({
            serverSide: true,
            ajax: {
                url: '/Post/Services1Section5/IndexAsync',
                type: 'POST',
                dataSrc: 'data',
            ...
            columns: [
                ...
                {
                    name: "Services1Section5Master_tenant.Services1Section5Master.ID",
                    data: "ID",
                    title: "ID",
                ...
                {
                    name: "Services1Section5Master_tenant.Services1Section5Master.HeadingText",
                    data: "HeadingText",
                    title: "Heading&nbsp;Text",
                    render: $.fn.dataTable.render.text(),
                    width: "25%",
                ...
                {
                    name: "Services1Section5Master_tenant.Services1Section5Master.AncharTagTitle",
                    data: "AncharTagTitle",
                 ...
                 {
                     name: "Services1Section5Master_tenant.Services1Section5Master.AncharTagUrl",
                     data: "AncharTagUrl",
                  ...
                  {
                    name: "Services1Section5Master.SubSubCategoryName",
                ...
                {
                    name: "Services1Section5Master_tenant.Services1Section5Master.DisplayIndex",
                    data: "DisplayIndex",
                    title: "Display&nbsp;Index",
                    render: $.fn.dataTable.render.text(),
                    width: "25%",
 ...
 {
                    name: "Services1Section5Master_tenant.Services1Section5Master.Url",
                    data: "Url",
                    title: "Url",
                    render: $.fn.dataTable.render.text(),
                    width: "25%",
 ...
 {
                    name: "Services1Section5Master_tenant.Services1Section5Master.Metadata",
                    data: "Metadata",
                    title: "Metadata",
                    render: $.fn.dataTable.render.text(),
                    width: "25%",
...
{
                    name: "Services1Section5Master_tenant.Services1Section5Master.MetaDescription",
...
{
                    name: "Services1Section5Master_tenant.Services1Section5Master.Keyword",
                    data: "Keyword",
                    title: "Keyword",
                    render: $.fn.dataTable.render.text(),
                    width: "25%",
...
{
                    name: "Services1Section5Master_tenant.Services1Section5Master.TotalViews",
                    data: "TotalViews",
                    title: "TotalViews",
                    render: $.fn.dataTable.render.text(),
                    width: "25%",
              ...
              {
                    name: "Services1Section5Master_tenant.Services1Section5Master.IsActive",
                    data: "IsActive",
                    title: "Is&nbsp;Active",
                    render: $.fn.dataTable.render.text(),
                    width: "25%",
                ...
                {
                    name: "Services1Section5Master_tenant.Services1Section5Master.CreatedBy",
                    data: "CreatedBy",
                    title: "Created&nbsp;By",
                    render: $.fn.dataTable.render.text(),
                    width: "6%",
                ...
                {
                    name: "Services1Section5Master_tenant.Services1Section5Master.CreatedOn",
                    data: "CreatedOn",
                    title: "Created&nbsp;On",
                    render: function (data, type, row, meta) {
                ...
                {
                    name: "Services1Section5Master_tenant.Services1Section5Master.UpdatedBy",
                    data: "UpdatedBy",
                    title: "Modified&nbsp;By",
                    render: $.fn.dataTable.render.text(),
                    width: "6%",
                ...
                {
                    name: "Services1Section5Master_tenant.Services1Section5Master.UpdatedOn",
                    data: "UpdatedOn",
                    title: "Modified&nbsp;On",
                    render: function (data, type, row, meta) {
                        let date = new Date(parseInt(data.replace('/Date(', '')));
