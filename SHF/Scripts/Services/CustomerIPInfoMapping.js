...
angular.module(config.app).service('CustomerIPInfoMappingCRUD', function ($http) {

    this.GetTableObject = function TableData() {
        let scope = angular.element(document.getElementById('CustomerIPInfoMappingControllerScope')).scope();
        let tenantId = scope.CustomerIPInfoMappingCreateOrEditViewModel.Tenant_ID == null ? 0 : scope.CustomerIPInfoMappingCreateOrEditViewModel.Tenant_ID;
        ...
        let oTable = $('#grdTable').DataTable({
            serverSide: true,
            ajax: {
                url: '/Post/CustomerIPInfoMapping/IndexAsync',
                type: 'POST',
                dataSrc: 'data',
            ...
            columns: [
                ...
                {
                    name: "CustomerInfo_tenant_Customer.CustomerInfo_tenant.CustomerInfo.ID",
                    data: "ID",
                    title: "ID",
               ...
               {
                    name: "CustomerInfo_tenant_Customer.CustomerInfo_tenant.CustomerInfo.Session_ID",
                    data: "Session_ID",
                    title: "Session",
                    render: $.fn.dataTable.render.text(),
                    width: "25%",
               ...
               {
                    name: "CustomerInfo_tenant_Customer.Customer.FirstName",
                    data: "FirstName",
                    title: "FirstName",
                    render: $.fn.dataTable.render.text(),
                    width: "25%",
                ...
                {
                    name: "CustomerInfo_tenant_Customer.Customer.LastName",
                    data: "LastName",
                    title: "LastName",
                    render: $.fn.dataTable.render.text(),
                    width: "25%",
                  ...
                  {
                   name: "CustomerInfo_tenant_Customer.Customer.DOB",
                    data: "DOB",
                    title: "DOB",
                    render: function (data, type, row, meta) {
                 ...
                 {
                   name: "CustomerInfo_tenant_Customer.Customer.EmailID",
                    data: "EmailID",
                    title: "EmailID",
                   render: $.fn.dataTable.render.text(),
                    width: "40%",
               ...
               {
                   name: "CustomerInfo_tenant_Customer.Customer.FullStreetAddress",
    ...
    this.LoadCustomerDropdown = function CustomerDropdown(tenantId) {
        let request = $http({
            method: "get",
            url: "/Get/CustomerIPInfoMapping/DropdownListbyTenantAsync?Id=" + tenantId
        });
        return request;
    }

    this.LoadAllCustomerIPInfoMappingByTenantIdAsync = function GetAllCustomerIPInfoMappingByTenantIdAsync(tenantId) {
        let request = $http({
            method: "get",
            url: "/Get/CustomerIPInfoMapping/GetAllCustomerIPInfoMappingByTenantIdAsync?Id=" + tenantId
        });
        return request;
    }
