...
angular.module(config.app).service('Services4Section3CRUD', function ($http) {

    this.GetTableObject = function TableData() {
        let scope = angular.element(document.getElementById('Services4Section3ControllerScope')).scope();
        let tenantId = scope.Services4Section3CreateOrEditViewModel.Tenant_ID == null ? 0 : scope.Services4Section3CreateOrEditViewModel.Tenant_ID;
        ...
        let oTable = $('#grdTable').DataTable({
            serverSide: true,
            ajax: {
                url: '/Post/Services4Section3/IndexAsync',
                type: 'POST',
                dataSrc: 'data',
            ...
            columns: [
                ...
                {
                    name: "Services4Section3_tenant.Services4Section3.ID",
                    data: "ID",
                    title: "ID",
                 ...
                 {
                     name: "Services4Section3_tenant.Services4Section3.Heading",
                     data: "Heading",
                     title: "Heading",
                     render: $.fn.dataTable.render.text(),
                     width: "25%",
                 ...
                 {
                     name: "Services4Section3_tenant.Services4Section3.ShortDescription",
                 ...
                 {
                    name: "Services4Section3.SubSubCategoryName",
                ...
                {
                    name: "Services4Section3_tenant.Services4Section3.DisplayIndex",
                    data: "DisplayIndex",
                    title: "Display&nbsp;Index",
                    render: $.fn.dataTable.render.text(),
                    width: "25%",
 ...
 {
                    name: "Services4Section3_tenant.Services4Section3.Url",
                    data: "Url",
                    title: "Url",
                    render: $.fn.dataTable.render.text(),
                    width: "25%",
 ...
 {
                    name: "Services4Section3_tenant.Services4Section3.Metadata",
                    data: "Metadata",
                    title: "Metadata",
                    render: $.fn.dataTable.render.text(),
                    width: "25%",
...
{
                    name: "Services4Section3_tenant.Services4Section3.MetaDescription",
...
{
                    name: "Services4Section3_tenant.Services4Section3.Keyword",
                    data: "Keyword",
                    title: "Keyword",
                    render: $.fn.dataTable.render.text(),
                    width: "25%",
...
{
                    name: "Services4Section3_tenant.Services4Section3.TotalViews",
                    data: "TotalViews",
                    title: "TotalViews",
                    render: $.fn.dataTable.render.text(),
                    width: "25%",
              ...
              {
                    name: "Services4Section3_tenant.Services4Section3.IsActive",
                    data: "IsActive",
                    title: "Is&nbsp;Active",
                    render: $.fn.dataTable.render.text(),
                    width: "25%",
                ...
                {
                    name: "Services4Section3_tenant.Services4Section3.CreatedBy",
                    data: "CreatedBy",
                    title: "Created&nbsp;By",
                    render: $.fn.dataTable.render.text(),
                    width: "6%",
                ...
                {
                    name: "Services4Section3_tenant.Services4Section3.CreatedOn",
                    data: "CreatedOn",
                    title: "Created&nbsp;On",
                    render: function (data, type, row, meta) {
                ...
                {
                    name: "Services4Section3_tenant.Services4Section3.UpdatedBy",
                    data: "UpdatedBy",
                    title: "Modified&nbsp;By",
                    render: $.fn.dataTable.render.text(),
                    width: "6%",
                ...
                {
                    name: "Services4Section3_tenant.Services4Section3.UpdatedOn",
                    data: "UpdatedOn",
                    title: "Modified&nbsp;On",
                    render: function (data, type, row, meta) {
                        let date = new Date(parseInt(data.replace('/Date(', '')));
