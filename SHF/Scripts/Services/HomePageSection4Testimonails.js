...
angular.module(config.app).service('HomePageSection4TestimonailsCRUD', function ($http) {

    this.GetTableObject = function TableData() {
        let scope = angular.element(document.getElementById('HomePageSection4TestimonailsControllerScope')).scope();
        let tenantId = scope.HomePageSection4TestimonailsCreateOrEditViewModel.Tenant_ID == null ? 0 : scope.HomePageSection4TestimonailsCreateOrEditViewModel.Tenant_ID;
        ...
        let oTable = $('#grdTable').DataTable({
            serverSide: true,
            ajax: {
                url: '/Post/HomePageSection4Testimonails/IndexAsync',
                type: 'POST',
                dataSrc: 'data',
            ...
            columns: [
                ...
                {
                    name: "HomePageSection4Testimonails.ID",
                    data: "ID",
                    title: "ID",
                ...
                {
                    name: "HomePageSection4Testimonails.Description",
                    data: "Description",
                    title: "Description",
                    render: $.fn.dataTable.render.text(),
                    width: "25%",
                ...
                {
                    name: "HomePageSection4Testimonails.Name",
                    data: "Name",
                    title: "Name",
                    render: $.fn.dataTable.render.text(),
                    width: "25%",
                ...
                {
                    name: "HomePageSection4Testimonails.Designation",
                    data: "Designation",
                    title: "Designation",
                    render: $.fn.dataTable.render.text(),
                    width: "25%",
                 ...
                 {
                     name: "HomePageSection4Testimonails.DisplayIndex",
                     data: "DisplayIndex",
                     title: "Display&nbsp;Index",
                     render: $.fn.dataTable.render.text(),
                     width: "25%",
                ...
                {
                    name: "HomePageSection4Testimonails.Url",
                    data: "Url",
                    title: "Url",
                    render: $.fn.dataTable.render.text(),
                    width: "25%",
                ...
                {
                    name: "HomePageSection4Testimonails.Metadata",
                    data: "Metadata",
                    title: "Metadata",
                    render: $.fn.dataTable.render.text(),
                    width: "25%",
                ...
                {
                    name: "HomePageSection4Testimonails.MetaDescription",
                ...
                {
                    name: "HomePageSection4Testimonails.Keyword",
                    data: "Keyword",
                    title: "Keyword",
                    render: $.fn.dataTable.render.text(),
                    width: "25%",
                ...
                {
                    name: "HomePageSection4Testimonails.TotalViews",
                    data: "TotalViews",
                    title: "TotalViews",
                    render: $.fn.dataTable.render.text(),
                    width: "25%",
              ...
              {
                  name: "HomePageSection4Testimonails.IsActive",
                  data: "IsActive",
                  title: "Is&nbsp;Active",
                  render: $.fn.dataTable.render.text(),
                  width: "25%",
                ...
                {
                    name: "HomePageSection4Testimonails.CreatedBy",
                    data: "CreatedBy",
                    title: "Created&nbsp;By",
                    render: $.fn.dataTable.render.text(),
                    width: "6%",
                ...
                {
                    name: "HomePageSection4Testimonails.CreatedOn",
                    data: "CreatedOn",
                    title: "Created&nbsp;On",
                    render: function (data, type, row, meta) {
                ...
                {
                    name: "HomePageSection4Testimonails.UpdatedBy",
                    data: "UpdatedBy",
                    title: "Modified&nbsp;By",
                    render: $.fn.dataTable.render.text(),
                    width: "6%",
                ...
                {
                    name: "HomePageSection4Testimonails.UpdatedOn",
                    data: "UpdatedOn",
                    title: "Modified&nbsp;On",
                    render: function (data, type, row, meta) {
                        let date = new Date(parseInt(data.replace('/Date(', '')));
    ...
    this.LoadSubSubCategoriesDropdown = function SubSubCategoriesDropdown(tenantId) {
        let request = $http({
            method: "get",
            url: "/Get/HomePageSection4Testimonails/DropdownListbyTenantAsync?Id=" + tenantId
        });
        return request;
    }
