...
angular.module(config.app).service('FAQMasterCRUD', function ($http) {

    this.GetTableObject = function TableData() {
        let scope = angular.element(document.getElementById('FAQMasterControllerScope')).scope();
        let tenantId = scope.FAQMasterCreateOrEditViewModel.Tenant_ID == null ? 0 : scope.FAQMasterCreateOrEditViewModel.Tenant_ID;
...

{
    ...
    this.LoadFAQDropdown = function FAQDropdown(tenantId) {
        let request = $http({
            method: "get",
            url: "/Get/FAQMaster/DropdownListbyTenantAsync?Id=" + tenantId
        });
        return request;
    }
    ...
    this.LoadPurchaseProductDropdown = function PurchaseProductDropdown(tenantId) {
        let request = $http({
            method: "get",
            url: "/Get/FAQMaster/PurchaseDropdownListbyTenantAsync?Id=" + tenantId
        });
        return request;
    }
    ...
    this.LoadPurchaseProductDropdownByVendor = function PurchaseProductDropdownByVendor(vendorId) {
        let request = $http({
            method: "get",
            url: "/Get/FAQMaster/PurchaseDropdownListbyVendorAsync?Id=" + vendorId
        });
        return request;
    }
    ...
    this.LoadSaleableProductDropdownByTenant = function SaleableProductDropdownByTenantId(tenantId) {
        let request = $http({
            method: "get",
            url: "/Get/FAQMaster/SaleableProductDropdownListbyTenantAsync?Id=" + tenantId
        });
        return request;
    }
    ...
    this.LoadAllProductDropdownByVendorId = function AllProductDropdownByVendorId(vendorId) {
        let request = $http({
            method: "get",
            url: "/Get/FAQMaster/AllProductDropdownListByVendorAsync?Id=" + vendorId
        });
        return request;
    }
