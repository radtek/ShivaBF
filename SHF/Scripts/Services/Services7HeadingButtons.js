...
angular.module(config.app).service('Services7HeadingButtonsCRUD', function ($http) {

    this.GetTableObject = function TableData() {
        let scope = angular.element(document.getElementById('Services7HeadingButtonsControllerScope')).scope();
        let tenantId = scope.Services7HeadingButtonsCreateOrEditViewModel.Tenant_ID == null ? 0 : scope.Services7HeadingButtonsCreateOrEditViewModel.Tenant_ID;
        ...
        let oTable = $('#grdTable').DataTable({
            serverSide: true,
            ajax: {
                url: '/Post/Services7HeadingButtons/IndexAsync',
                type: 'POST',
                dataSrc: 'data',
            ...
            columns: [
                ...
                {
                    name: "Services7HeadingButtons_tenant.Services7HeadingButtons.ID",
                    data: "ID",
                    title: "ID",
                ...
                {
                    name: "Services7HeadingButtons_tenant.Services7HeadingButtons.AncharTagTitle",
                    data: "AncharTagTitle",
                 ...
                 {
                     name: "Services7HeadingButtons_tenant.Services7HeadingButtons.AncharTagUrl",
                     data: "AncharTagUrl",
                 ...
                 {
                    name: "Services7HeadingButtons.SubSubCategoryName",
                ...
                {
                    name: "Services7HeadingButtons_tenant.Services7HeadingButtons.DisplayIndex",
                    data: "DisplayIndex",
                    title: "Display&nbsp;Index",
                    render: $.fn.dataTable.render.text(),
                    width: "25%",
 ...
 {
                    name: "Services7HeadingButtons_tenant.Services7HeadingButtons.Url",
                    data: "Url",
                    title: "Url",
                    render: $.fn.dataTable.render.text(),
                    width: "25%",
 ...
 {
                    name: "Services7HeadingButtons_tenant.Services7HeadingButtons.Metadata",
                    data: "Metadata",
                    title: "Metadata",
                    render: $.fn.dataTable.render.text(),
                    width: "25%",
...
{
                    name: "Services7HeadingButtons_tenant.Services7HeadingButtons.MetaDescription",
...
{
                    name: "Services7HeadingButtons_tenant.Services7HeadingButtons.Keyword",
                    data: "Keyword",
                    title: "Keyword",
                    render: $.fn.dataTable.render.text(),
                    width: "25%",
...
{
                    name: "Services7HeadingButtons_tenant.Services7HeadingButtons.TotalViews",
                    data: "TotalViews",
                    title: "TotalViews",
                    render: $.fn.dataTable.render.text(),
                    width: "25%",
              ...
              {
                    name: "Services7HeadingButtons_tenant.Services7HeadingButtons.IsActive",
                    data: "IsActive",
                    title: "Is&nbsp;Active",
                    render: $.fn.dataTable.render.text(),
                    width: "25%",
                ...
                {
                    name: "Services7HeadingButtons_tenant.Services7HeadingButtons.CreatedBy",
                    data: "CreatedBy",
                    title: "Created&nbsp;By",
                    render: $.fn.dataTable.render.text(),
                    width: "6%",
                ...
                {
                    name: "Services7HeadingButtons_tenant.Services7HeadingButtons.CreatedOn",
                    data: "CreatedOn",
                    title: "Created&nbsp;On",
                    render: function (data, type, row, meta) {
                ...
                {
                    name: "Services7HeadingButtons_tenant.Services7HeadingButtons.UpdatedBy",
                    data: "UpdatedBy",
                    title: "Modified&nbsp;By",
                    render: $.fn.dataTable.render.text(),
                    width: "6%",
                ...
                {
                    name: "Services7HeadingButtons_tenant.Services7HeadingButtons.UpdatedOn",
                    data: "UpdatedOn",
                    title: "Modified&nbsp;On",
                    render: function (data, type, row, meta) {
                        let date = new Date(parseInt(data.replace('/Date(', '')));
                ...
                },
{
 ...
 $('#grdTable tbody').on('click', '.btn-preview', function () {
            let rowData = oTable.row($(this).parents('tr')).data();
            let scope = angular.element(document.getElementById('Services7HeadingButtonsControllerScope')).scope();
            scope.Preview('services7.html?u='+rowData.ServiceUrl);
        });
    }
