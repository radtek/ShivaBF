...
angular.module(config.app).service('Services4Section678FieldMasterCRUD', function ($http) {

    this.GetTableObject = function TableData() {
        let scope = angular.element(document.getElementById('Services4Section678FieldMasterControllerScope')).scope();
        let tenantId = scope.Services4Section678FieldMasterCreateOrEditViewModel.Tenant_ID == null ? 0 : scope.Services4Section678FieldMasterCreateOrEditViewModel.Tenant_ID;
        ...
        let oTable = $('#grdTable').DataTable({
            serverSide: true,
            ajax: {
                url: '/Post/Services4Section678FieldMaster/IndexAsync',
                type: 'POST',
                dataSrc: 'data',
            ...
            columns: [
                ...
                {
                    name: "Services4Section678FieldMaster_tenant.Services4Section678FieldMaster.ID",
                    data: "ID",
                    title: "ID",
                 ...
                 {
                     name: "Services4Section678FieldMaster_tenant.Services4Section678FieldMaster.FieldName",
                     data: "FieldName",
                     title: "FieldName",
                     render: $.fn.dataTable.render.text(),
                     width: "25%",
                 ...
                 {
                    name: "Services4Section678FieldMaster.SubSubCategoryName",
                ...
                {
                    name: "Services4Section678FieldMaster_tenant.Services4Section678FieldMaster.DisplayIndex",
                    data: "DisplayIndex",
                    title: "Display&nbsp;Index",
                    render: $.fn.dataTable.render.text(),
                    width: "25%",
 ...
 {
                    name: "Services4Section678FieldMaster_tenant.Services4Section678FieldMaster.Url",
                    data: "Url",
                    title: "Url",
                    render: $.fn.dataTable.render.text(),
                    width: "25%",
 ...
 {
                    name: "Services4Section678FieldMaster_tenant.Services4Section678FieldMaster.Metadata",
                    data: "Metadata",
                    title: "Metadata",
                    render: $.fn.dataTable.render.text(),
                    width: "25%",
...
{
                    name: "Services4Section678FieldMaster_tenant.Services4Section678FieldMaster.MetaDescription",
...
{
                    name: "Services4Section678FieldMaster_tenant.Services4Section678FieldMaster.Keyword",
                    data: "Keyword",
                    title: "Keyword",
                    render: $.fn.dataTable.render.text(),
                    width: "25%",
...
{
                    name: "Services4Section678FieldMaster_tenant.Services4Section678FieldMaster.TotalViews",
                    data: "TotalViews",
                    title: "TotalViews",
                    render: $.fn.dataTable.render.text(),
                    width: "25%",
              ...
              {
                    name: "Services4Section678FieldMaster_tenant.Services4Section678FieldMaster.IsActive",
                    data: "IsActive",
                    title: "Is&nbsp;Active",
                    render: $.fn.dataTable.render.text(),
                    width: "25%",
                ...
                {
                    name: "Services4Section678FieldMaster_tenant.Services4Section678FieldMaster.CreatedBy",
                    data: "CreatedBy",
                    title: "Created&nbsp;By",
                    render: $.fn.dataTable.render.text(),
                    width: "6%",
                ...
                {
                    name: "Services4Section678FieldMaster_tenant.Services4Section678FieldMaster.CreatedOn",
                    data: "CreatedOn",
                    title: "Created&nbsp;On",
                    render: function (data, type, row, meta) {
                ...
                {
                    name: "Services4Section678FieldMaster_tenant.Services4Section678FieldMaster.UpdatedBy",
                    data: "UpdatedBy",
                    title: "Modified&nbsp;By",
                    render: $.fn.dataTable.render.text(),
                    width: "6%",
                ...
                {
                    name: "Services4Section678FieldMaster_tenant.Services4Section678FieldMaster.UpdatedOn",
                    data: "UpdatedOn",
                    title: "Modified&nbsp;On",
                    render: function (data, type, row, meta) {
                        let date = new Date(parseInt(data.replace('/Date(', '')));
