...
angular.module(config.app).service('Services8MasterCRUD', function ($http) {

    this.GetTableObject = function TableData() {
        let scope = angular.element(document.getElementById('Services8MasterControllerScope')).scope();
        let tenantId = scope.Services8MasterCreateOrEditViewModel.Tenant_ID == null ? 0 : scope.Services8MasterCreateOrEditViewModel.Tenant_ID;
        ...
        let oTable = $('#grdTable').DataTable({
            serverSide: true,
            ajax: {
                url: '/Post/ServiceType8/IndexAsync',
                type: 'POST',
                dataSrc: 'data',
            ...
            columns: [
                ...
                {
                    name: "Services8Master_tenant.Services8Master.ID",
                    data: "ID",
                    title: "ID",
                ...
                },
               {
                ...
                {
                    name: "Services8Master_tenant.Services8Master.BannerHeadingDescription",
                ...
                {
                    name: "Services8Master_tenant.Services8Master.Section1Heading",
                ...
                },
                {
                    ...
                    title: "Section2BannerHeadingDescription",
                    render: $.fn.dataTable.render.text(),
                    width: "25%",
                    targets: 10
                },
                ...
                {
                    name: "Services8Master_tenant.Services8Master.Section4Heading",
                ...
                {
                    name: "Services8Master_tenant.Services8Master.Section5Heading",
 ...
 {
                    name: "Services8Master_tenant.Services8Master.Section5Description",
 ...
 {
                    name: "Services8Master_tenant.Services8Master.Section5TextboxMaskedText",
                 ...
                 {
                    name: "Services8Master_tenant.Services8Master.DisplayIndex",
                    data: "DisplayIndex",
                    title: "Display&nbsp;Index",
                    render: $.fn.dataTable.render.text(),
                    width: "25%",
                ...
                },
               {
                ...
                {
                    name: "Services8Master_tenant.Services8Master.MetaDescription",
                ...
                {
                    name: "Services8Master_tenant.Services8Master.Keyword",
                    data: "Keyword",
                    title: "Keyword",
                    render: $.fn.dataTable.render.text(),
                    width: "25%",
                ...
                {
                    name: "Services8Master_tenant.Services8Master.TotalViews",
                    data: "TotalViews",
                    title: "TotalViews",
                    render: $.fn.dataTable.render.text(),
                    width: "25%",
              ...
              {
                    name: "Services8Master_tenant.Services8Master.IsActive",
                    data: "IsActive",
                    title: "Is&nbsp;Active",
                    render: $.fn.dataTable.render.text(),
                    width: "25%",
                ...
                {
                    name: "Services8Master_tenant.Services8Master.CreatedBy",
                    data: "CreatedBy",
                    title: "Created&nbsp;By",
                    render: $.fn.dataTable.render.text(),
                    width: "6%",
                ...
                {
                    name: "Services8Master_tenant.Services8Master.CreatedOn",
                    data: "CreatedOn",
                    title: "Created&nbsp;On",
                    render: function (data, type, row, meta) {
                ...
                {
                    name: "Services8Master_tenant.Services8Master.UpdatedBy",
                    data: "UpdatedBy",
                    title: "Modified&nbsp;By",
                    render: $.fn.dataTable.render.text(),
                    width: "6%",
                ...
                {
                    name: "Services8Master_tenant.Services8Master.UpdatedOn",
                    data: "UpdatedOn",
                    title: "Modified&nbsp;On",
                    render: function (data, type, row, meta) {
                        let date = new Date(parseInt(data.replace('/Date(', '')));
                ...
                },
{
       ...
       $('#grdTable tbody').on('click', '.btn-preview', function () {
            let rowData = oTable.row($(this).parents('tr')).data();
            let scope = angular.element(document.getElementById('Services8MasterControllerScope')).scope();
            scope.Preview('services8.html?u='+rowData.Url);
        });
    }
 ...
 this.LoadSubSubCategoriesDropdown = function SubSubCategoriesDropdown(tenantId) {
        let request = $http({
            method: "get",
            url: "/Get/Services8Master/DropdownListbyTenantAsync?Id=" + tenantId
        });
        return request;
    }
