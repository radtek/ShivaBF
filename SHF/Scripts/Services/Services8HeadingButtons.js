...
angular.module(config.app).service('Services8HeadingButtonsCRUD', function ($http) {

    this.GetTableObject = function TableData() {
        let scope = angular.element(document.getElementById('Services8HeadingButtonsControllerScope')).scope();
        let tenantId = scope.Services8HeadingButtonsCreateOrEditViewModel.Tenant_ID == null ? 0 : scope.Services8HeadingButtonsCreateOrEditViewModel.Tenant_ID;
        ...
        let oTable = $('#grdTable').DataTable({
            serverSide: true,
            ajax: {
                url: '/Post/Services8HeadingButtons/IndexAsync',
                type: 'POST',
                dataSrc: 'data',
            ...
            columns: [
                ...
                {
                    name: "Services8HeadingButtons_tenant.Services8HeadingButtons.ID",
                    data: "ID",
                    title: "ID",
                ...
                {
                    name: "Services8HeadingButtons_tenant.Services8HeadingButtons.AncharTagTitle",
                    data: "AncharTagTitle",
                 ...
                 {
                     name: "Services8HeadingButtons_tenant.Services8HeadingButtons.AncharTagUrl",
                     data: "AncharTagUrl",
                 ...
                 {
                    name: "Services8HeadingButtons.SubSubCategoryName",
                ...
                {
                    name: "Services8HeadingButtons_tenant.Services8HeadingButtons.DisplayIndex",
                    data: "DisplayIndex",
                    title: "Display&nbsp;Index",
                    render: $.fn.dataTable.render.text(),
                    width: "25%",
 ...
 {
                    name: "Services8HeadingButtons_tenant.Services8HeadingButtons.Url",
                    data: "Url",
                    title: "Url",
                    render: $.fn.dataTable.render.text(),
                    width: "25%",
 ...
 {
                    name: "Services8HeadingButtons_tenant.Services8HeadingButtons.Metadata",
                    data: "Metadata",
                    title: "Metadata",
                    render: $.fn.dataTable.render.text(),
                    width: "25%",
...
{
                    name: "Services8HeadingButtons_tenant.Services8HeadingButtons.MetaDescription",
...
{
                    name: "Services8HeadingButtons_tenant.Services8HeadingButtons.Keyword",
                    data: "Keyword",
                    title: "Keyword",
                    render: $.fn.dataTable.render.text(),
                    width: "25%",
...
{
                    name: "Services8HeadingButtons_tenant.Services8HeadingButtons.TotalViews",
                    data: "TotalViews",
                    title: "TotalViews",
                    render: $.fn.dataTable.render.text(),
                    width: "25%",
              ...
              {
                    name: "Services8HeadingButtons_tenant.Services8HeadingButtons.IsActive",
                    data: "IsActive",
                    title: "Is&nbsp;Active",
                    render: $.fn.dataTable.render.text(),
                    width: "25%",
                ...
                {
                    name: "Services8HeadingButtons_tenant.Services8HeadingButtons.CreatedBy",
                    data: "CreatedBy",
                    title: "Created&nbsp;By",
                    render: $.fn.dataTable.render.text(),
                    width: "6%",
                ...
                {
                    name: "Services8HeadingButtons_tenant.Services8HeadingButtons.CreatedOn",
                    data: "CreatedOn",
                    title: "Created&nbsp;On",
                    render: function (data, type, row, meta) {
                ...
                {
                    name: "Services8HeadingButtons_tenant.Services8HeadingButtons.UpdatedBy",
                    data: "UpdatedBy",
                    title: "Modified&nbsp;By",
                    render: $.fn.dataTable.render.text(),
                    width: "6%",
                ...
                {
                    name: "Services8HeadingButtons_tenant.Services8HeadingButtons.UpdatedOn",
                    data: "UpdatedOn",
                    title: "Modified&nbsp;On",
                    render: function (data, type, row, meta) {
                        let date = new Date(parseInt(data.replace('/Date(', '')));
                ...
                },
{
      ...
      $('#grdTable tbody').on('click', '.btn-preview', function () {
            let rowData = oTable.row($(this).parents('tr')).data();
            let scope = angular.element(document.getElementById('Services8HeadingButtonsControllerScope')).scope();
            scope.Preview('services8.html?u='+rowData.ServiceUrl);
        });
    }
