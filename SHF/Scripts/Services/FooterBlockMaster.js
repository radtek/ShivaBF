...
angular.module(config.app).service('FooterBlockMasterCRUD', function ($http) {

    this.GetTableObject = function TableData() {
        let scope = angular.element(document.getElementById('FooterBlockMasterControllerScope')).scope();
        let tenantId = scope.FooterBlockMasterCreateOrEditViewModel.Tenant_ID == null ? 0 : scope.FooterBlockMasterCreateOrEditViewModel.Tenant_ID;
        ...
        let oTable = $('#grdTable').DataTable({
            serverSide: true,
            ajax: {
                url: '/Post/FooterBlockMaster/IndexAsync',
                type: 'POST',
                dataSrc: 'data',
 ...
 {
     name: "footerBlockMaster.Metadata",
     data: "Metadata",
     title: "Metadata",
     render: $.fn.dataTable.render.text(),
     width: "25%",
...
{
    name: "footerBlockMaster.MetaDescription",
...
{
    name: "footerBlockMaster.Keyword",
    data: "Keyword",
    title: "Keyword",
    render: $.fn.dataTable.render.text(),
    width: "25%",
...
{
    name: "footerBlockMaster.TotalViews",
    data: "TotalViews",
    title: "TotalViews",
    render: $.fn.dataTable.render.text(),
    width: "25%",
    targets: 9
              ...
              {
                  name: "footerBlockMaster.IsActive",
                  data: "IsActive",
                  title: "IsActive",
                  render: $.fn.dataTable.render.text(),
                  width: "25%",
                ...
                {
                    name: "footerBlockMaster.CreatedBy",
                    data: "CreatedBy",
                    title: "Created&nbsp;By",
                    render: $.fn.dataTable.render.text(),
                    width: "6%",
                ...
                {
                    name: "footerBlockMaster.CreatedOn",
                    data: "CreatedOn",
                    title: "Created&nbsp;On",
                    render: function (data, type, row, meta) {
                ...
                {
                    name: "footerBlockMaster.UpdatedBy",
                    data: "UpdatedBy",
                    title: "Modified&nbsp;By",
                    render: $.fn.dataTable.render.text(),
                    width: "6%",
                ...
                {
                    name: "footerBlockMaster.UpdatedOn",
                    data: "UpdatedOn",
                    title: "Modified&nbsp;On",
                    render: function (data, type, row, meta) {
                        let date = new Date(parseInt(data.replace('/Date(', '')));
