...
angular.module(config.app).service('HomePageSection2CRUD', function ($http) {

    this.GetTableObject = function TableData() {
        let scope = angular.element(document.getElementById('HomePageSection2ControllerScope')).scope();
        let tenantId = scope.HomePageSection2CreateOrEditViewModel.Tenant_ID == null ? 0 : scope.HomePageSection2CreateOrEditViewModel.Tenant_ID;
        ...
        let oTable = $('#grdTable').DataTable({
            serverSide: true,
            ajax: {
                url: '/Post/HomePageSection2/IndexAsync',
                type: 'POST',
                dataSrc: 'data',
            ...
            columns: [
                ...
                {
                    name: "HomePageSection2.BannerImagePath",
                ...
                {
                    name: "HomePageSection2.Heading1",
                    data: "Heading1",
                    title: "Heading1",
                    render: $.fn.dataTable.render.text(),
                    width: "25%",
                ...
                {
                    name: "HomePageSection2.Heading2",
                    data: "Heading2",
                    title: "Heading2",
                    render: $.fn.dataTable.render.text(),
                    width: "25%",
                ...
                {
                    name: "HomePageSection2.Heading3",
                    data: "Heading3",
                    title: "Heading3",
                    render: $.fn.dataTable.render.text(),
                    width: "25%",
                ...
                {
                    name: "HomePageSection2.Description1",
                    data: "Description1",
                    title: "Description1",
                    render: $.fn.dataTable.render.text(),
                    width: "25%",
                 ...
                 {
                     name: "HomePageSection2.Description2",
                     data: "Description2",
                     title: "Description2",
                     render: $.fn.dataTable.render.text(),
                     width: "25%",
                ...
                {
                    name: "HomePageSection2.MetaDescription",
                ...
                {
                    name: "HomePageSection2.TotalViews",
                    data: "TotalViews",
                    title: "TotalViews",
                    render: $.fn.dataTable.render.text(),
                    width: "25%",
              ...
              {
                  name: "HomePageSection2.IsActive",
                  data: "IsActive",
                  title: "Is&nbsp;Active",
                  render: $.fn.dataTable.render.text(),
                  width: "25%",
                ...
                {
                    name: "HomePageSection2.CreatedBy",
                    data: "CreatedBy",
                    title: "Created&nbsp;By",
                    render: $.fn.dataTable.render.text(),
                    width: "6%",
                ...
                {
                    name: "HomePageSection2.CreatedOn",
                    data: "CreatedOn",
                    title: "Created&nbsp;On",
                    render: function (data, type, row, meta) {
                ...
                {
                    name: "HomePageSection2.UpdatedBy",
                    data: "UpdatedBy",
                    title: "Modified&nbsp;By",
                    render: $.fn.dataTable.render.text(),
                    width: "6%",
                ...
                {
                    name: "HomePageSection2.UpdatedOn",
                    data: "UpdatedOn",
                    title: "Modified&nbsp;On",
                    render: function (data, type, row, meta) {
                        let date = new Date(parseInt(data.replace('/Date(', '')));
    ...
    this.LoadSubSubCategoriesDropdown = function SubSubCategoriesDropdown(tenantId) {
        let request = $http({
            method: "get",
            url: "/Get/HomePageSection2/DropdownListbyTenantAsync?Id=" + tenantId
        });
        return request;
    }
