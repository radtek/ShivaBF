...
angular.module(config.app).service('Services3MasterCRUD', function ($http) {

    this.GetTableObject = function TableData() {
        let scope = angular.element(document.getElementById('Services3MasterControllerScope')).scope();
        let tenantId = scope.Services3MasterCreateOrEditViewModel.Tenant_ID == null ? 0 : scope.Services3MasterCreateOrEditViewModel.Tenant_ID;
        ...
        let oTable = $('#grdTable').DataTable({
            serverSide: true,
            ajax: {
                url: '/Post/ServiceType3/IndexAsync',
                type: 'POST',
                dataSrc: 'data',
            ...
            columns: [
                ...
                {
                    name: "Services3Master_tenant.Services3Master.ID",
                    data: "ID",
                    title: "ID",
                ...
                {
                    name: "Services3Master_tenant.Services3Master.BannerImagePath",
                ...
                },
 {
                ...
                {
                    name: "Services3Master_tenant.Services3Master.BannerOnHeading",
                ...
                {
                    name: "Services3Master_tenant.Services3Master.BannerHeadingDescription",
                ...
                {
                    name: "Services3Master_tenant.Services3Master.Section1Heading",
                ...
                {
                    name: "Services3Master_tenant.Services3Master.Section1Description",
                ...
                {
                    name: "Services3Master_tenant.Services3Master.Section4Heading",
                ...
                {
                    name: "Services3Master_tenant.Services3Master.Section5Heading",
 ...
 {
                    name: "Services3Master_tenant.Services3Master.Section5Description",
 ...
 {
                    name: "Services3Master_tenant.Services3Master.Section5TextboxMaskedText",
                   ...
                   {
                    name: "Services3Master_tenant.Services3Master.Section6PriceingHeading",
                ...
                {
                    name: "Services3Master_tenant.Services3Master.Section6PriceingDescription",
                 ...
                 {
                    name: "Services3Master_tenant.Services3Master.DisplayIndex",
                    data: "DisplayIndex",
                    title: "Display&nbsp;Index",
                    render: $.fn.dataTable.render.text(),
                    width: "25%",
                ...
                {
                    name: "Services3Master_tenant.Services3Master.MetaDescription",
                ...
                {
                    name: "Services3Master_tenant.Services3Master.Keyword",
                    data: "Keyword",
                    title: "Keyword",
                    render: $.fn.dataTable.render.text(),
                    width: "25%",
                ...
                {
                    name: "Services3Master_tenant.Services3Master.TotalViews",
                    data: "TotalViews",
                    title: "TotalViews",
                    render: $.fn.dataTable.render.text(),
                    width: "25%",
              ...
              {
                    name: "Services3Master_tenant.Services3Master.IsActive",
                    data: "IsActive",
                    title: "Is&nbsp;Active",
                    render: $.fn.dataTable.render.text(),
                    width: "25%",
                ...
                {
                    name: "Services3Master_tenant.Services3Master.CreatedBy",
                    data: "CreatedBy",
                    title: "Created&nbsp;By",
                    render: $.fn.dataTable.render.text(),
                    width: "6%",
                ...
                {
                    name: "Services3Master_tenant.Services3Master.CreatedOn",
                    data: "CreatedOn",
                    title: "Created&nbsp;On",
                    render: function (data, type, row, meta) {
                ...
                {
                    name: "Services3Master_tenant.Services3Master.UpdatedBy",
                    data: "UpdatedBy",
                    title: "Modified&nbsp;By",
                    render: $.fn.dataTable.render.text(),
                    width: "6%",
                ...
                {
                    name: "Services3Master_tenant.Services3Master.UpdatedOn",
                    data: "UpdatedOn",
                    title: "Modified&nbsp;On",
                    render: function (data, type, row, meta) {
                        let date = new Date(parseInt(data.replace('/Date(', '')));
...
$('#grdTable tbody').on('click', '.btn-preview', function () {
            let rowData = oTable.row($(this).parents('tr')).data();
            let scope = angular.element(document.getElementById('Services3MasterControllerScope')).scope();
            scope.Preview('services3.html?u='+rowData.Url);
        });
    }
 ...
 this.LoadSubSubCategoriesDropdown = function SubSubCategoriesDropdown(tenantId) {
        let request = $http({
            method: "get",
            url: "/Get/Services3Master/DropdownListbyTenantAsync?Id=" + tenantId
        });
        return request;
    }
