...
angular.module(config.app).service('Services4Section2MasterCRUD', function ($http) {

    this.GetTableObject = function TableData() {
        let scope = angular.element(document.getElementById('Services4Section2MasterControllerScope')).scope();
        let tenantId = scope.Services4Section2MasterCreateOrEditViewModel.Tenant_ID == null ? 0 : scope.Services4Section2MasterCreateOrEditViewModel.Tenant_ID;
        ...
        let oTable = $('#grdTable').DataTable({
            serverSide: true,
            ajax: {
                url: '/Post/Services4Section2Master/IndexAsync',
                type: 'POST',
                dataSrc: 'data',
            ...
            columns: [
                ...
                {
                    name: "Services4Section2Master_tenant.Services4Section2Master.ID",
                    data: "ID",
                    title: "ID",
                 ...
                 {
                     name: "Services4Section2Master_tenant.Services4Section2Master.Heading",
                     data: "Heading",
                     title: "Heading",
                     render: $.fn.dataTable.render.text(),
                     width: "25%",
                 ...
                 {
                     name: "Services4Section2Master_tenant.Services4Section2Master.Description",
                     data: "Description",
                     title: "Description",
                     render: $.fn.dataTable.render.text(),
                     width: "25%",
                 ...
                 {
                    name: "Services4Section2Master.SubSubCategoryName",
                ...
                {
                    name: "Services4Section2Master_tenant.Services4Section2Master.DisplayIndex",
                    data: "DisplayIndex",
                    title: "Display&nbsp;Index",
                    render: $.fn.dataTable.render.text(),
                    width: "25%",
 ...
 {
                    name: "Services4Section2Master_tenant.Services4Section2Master.Url",
                    data: "Url",
                    title: "Url",
                    render: $.fn.dataTable.render.text(),
                    width: "25%",
 ...
 {
                    name: "Services4Section2Master_tenant.Services4Section2Master.Metadata",
                    data: "Metadata",
                    title: "Metadata",
                    render: $.fn.dataTable.render.text(),
                    width: "25%",
...
{
                    name: "Services4Section2Master_tenant.Services4Section2Master.MetaDescription",
...
{
                    name: "Services4Section2Master_tenant.Services4Section2Master.Keyword",
                    data: "Keyword",
                    title: "Keyword",
                    render: $.fn.dataTable.render.text(),
                    width: "25%",
...
{
                    name: "Services4Section2Master_tenant.Services4Section2Master.TotalViews",
                    data: "TotalViews",
                    title: "TotalViews",
                    render: $.fn.dataTable.render.text(),
                    width: "25%",
              ...
              {
                    name: "Services4Section2Master_tenant.Services4Section2Master.IsActive",
                    data: "IsActive",
                    title: "Is&nbsp;Active",
                    render: $.fn.dataTable.render.text(),
                    width: "25%",
                ...
                {
                    name: "Services4Section2Master_tenant.Services4Section2Master.CreatedBy",
                    data: "CreatedBy",
                    title: "Created&nbsp;By",
                    render: $.fn.dataTable.render.text(),
                    width: "6%",
                ...
                {
                    name: "Services4Section2Master_tenant.Services4Section2Master.CreatedOn",
                    data: "CreatedOn",
                    title: "Created&nbsp;On",
                    render: function (data, type, row, meta) {
                ...
                {
                    name: "Services4Section2Master_tenant.Services4Section2Master.UpdatedBy",
                    data: "UpdatedBy",
                    title: "Modified&nbsp;By",
                    render: $.fn.dataTable.render.text(),
                    width: "6%",
                ...
                {
                    name: "Services4Section2Master_tenant.Services4Section2Master.UpdatedOn",
                    data: "UpdatedOn",
                    title: "Modified&nbsp;On",
                    render: function (data, type, row, meta) {
                        let date = new Date(parseInt(data.replace('/Date(', '')));
