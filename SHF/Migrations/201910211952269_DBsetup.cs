namespace SHF.Migrations
{
    ...
    public partial class DBsetup : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                "dbo.Tbl_Services4Section2Master",
                c => new
                    {
                        ID = c.Long(nullable: false, identity: true),
                        Service_Id = c.Long(),
            ...
            CreateTable(
                "dbo.Tbl_Services4Section2MasterChild",
                c => new
                    {
                        ID = c.Long(nullable: false, identity: true),
                        Service_Id = c.Long(),
            ...
            CreateTable(
                "dbo.Tbl_Services4Section3DownloadMaster",
                c => new
                    {
                        ID = c.Long(nullable: false, identity: true),
                        Service_Id = c.Long(),
            ...
            CreateTable(
                "dbo.Tbl_Services4Section3Master",
                c => new
                    {
                        ID = c.Long(nullable: false, identity: true),
                        Service_Id = c.Long(),
                ...
                c => new
                    {
                        ...
                        Section1Heading = c.String(),
                        Section1Description = c.String(),
                        Section2BannerHeading = c.String(),
        ...
        public override void Down()
        {
            ...
            DropTable("dbo.Tbl_Services4Section3Master");
            DropTable("dbo.Tbl_Services4Section3DownloadMaster");
            DropTable("dbo.Tbl_Services4Section3");
            DropTable("dbo.Tbl_Services4Section2MasterChild");
            DropTable("dbo.Tbl_Services4Section2Master");
