...
DECLARE 
@Code_ID BIGINT=NULL ,
@CodeValue VARCHAR(4)='SEC1' ,
@Description VARCHAR(100)='Section Type 1' ,
@Data_1_Type nvarchar(4) = 'Section Type 1',
@Data_2_Caption nvarchar(100) = NULL,
@Data_2_Type  nvarchar(4) = NULL,
@Data_3_Caption  nvarchar(100) = NULL,
@Data_3_Type  nvarchar(4) = NULL,
...
SELECT TOP 1 @Code_ID = C.ID FROM dbo.Tbl_Code C WITH(NOLOCK) WHERE C.Data_1_Caption ='SectionType'
...
DECLARE 
@Code_ID BIGINT=NULL ,
@CodeValue VARCHAR(4)='SEC2' ,
@Description VARCHAR(100)='Section Type 2' ,
@Data_1_Type nvarchar(4) = 'Section Type 2',
@Data_2_Caption nvarchar(100) = NULL,
@Data_2_Type  nvarchar(4) = NULL,
@Data_3_Caption  nvarchar(100) = NULL,
@Data_3_Type  nvarchar(4) = NULL,
...
DECLARE 
@Code_ID BIGINT=NULL ,
@CodeValue VARCHAR(4)='SEC3' ,
@Description VARCHAR(100)='Section Type 3' ,
@Data_1_Type nvarchar(4) = 'Section Type 3',
@Data_2_Caption nvarchar(100) = NULL,
@Data_2_Type  nvarchar(4) = NULL,
@Data_3_Caption  nvarchar(100) = NULL,
@Data_3_Type  nvarchar(4) = NULL,
